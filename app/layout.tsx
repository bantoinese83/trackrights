...
export const metadata: Metadata = {
    ...
    description: 'TrackRights uses AI to simplify and explain music contracts in producer-friendly terms. Understand complex legal jargon effortlessly.',
    keywords: ['music contract analysis', 'AI contract simplification', 'music producer tools', 'legal jargon simplification', 'contract review', 'music industry'],
