...
export function ComicBanner() {
  ...
  const statsConfig = [
    ...
    {
      icon: Users,
      value: stats.musicProfessionals,
      label: 'Music Professionals',
      suffix: '+',
    },
    {
      icon: Clock,
    ...
    {
      icon: FileText,
      value: stats.generatedContracts,
    ...
    <section className="relative py-10 overflow-hidden bg-gradient-to-b from-purple-900 to-indigo-900">
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-0 left-0 w-full sm:w-1/3 h-1/3 sm:h-full">
          <Image
            ...
            alt="Comic panel showing music industry contract signing"
            fill
      ...
      <div className="relative container mx-auto px-4 text-center z-10">
        ...
        >
          ...
          industry professionals who trust TrackRights.com to analyze and
          simplify their contracts
        </motion.p>
