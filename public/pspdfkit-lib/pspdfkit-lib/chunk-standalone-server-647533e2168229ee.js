  ...
  [9042],
  {
      ...
      class h {
        ...
        initializeLinearizedInstance() {
          if (this.linearizedInstance && !this.linearizedInstance.isDestroyed())
            throw new o.uE('Linearized loader is already allocated');
          (0, o.V1)(this.ctx.wasmCtx, 'Wasm context is not available');
          const e = (this.linearizedInstance = new i.MX.LinearizedInstance(
            this.ctx.wasmCtx,
            r.EA
          ));
          return (
            ...
            (0, c.attachLinearizedInstance)(this.ctx, e),
            this.linearizedInstance
          );
        }
        async normallyOpenLinearizedDocument(e, t) {
          (0, o.V1)(this.ctx.wasmCtx, 'Wasm context is not available'),
            ...
            (0, o.V1)(
              this.linearizedInstance.state ===
                i.MX.LinearizedInstanceState.Complete,
              'PDF isnt completely downloaded'
            ),
        ...
        fetchPageInfoWhileDownloading(e, t) {
          const n = this.linearizedInstance;
          return (
            (0, o.V1)(n, 'Linearized loader is not available'),
            n.whenPageAvailable(e, t)
          );
        }
        renderTile(e, t, n, a, s, o) {
          let r;
          o &&
            (r = {
              annotations: o.annotations
                ...
                .toJS()
                .map((e) => ({ content: e })),
              formFieldValues: o.formFieldValues.map(d.cA).toJS(),
              formFields: o.formFields.map(d.T7).toJS(),
              signatures: o.signatures || [],
              attachments: o.attachments,
            });
          const c = i.MX.Renderer.renderTile(
            this.ctx,
            e,
            t,
            n,
          ...
          return { promise: c.promise, cancel: c.cancel };
        }
        getTextLines(e) {
          return i.MX.Text.getTextForPage(this.ctx, e).then((t) =>
            (0, m.K0)({ textLines: t }, e)
          );
        }
        getContentTree(e) {
          return i.MX.Text.getContentTreeForPage(this.ctx, e).then((t) => {
            let n = [],
              a = 0,
              i = 0;
            return (
              (n = t.reduce((t, n) => {
                let { nodes: s } = n;
                const o = (0, m.l1)(s, e, t.length, a, i);
                return (
                  (a += o.reduce((e, t) => {
                    let { textLines: n } = t;
                    return e + n.size;
      ...
      class d {
        constructor() {
          (0, a.A)(this, 'attachmentsCache', (0, i.T5)()),
            ...
            (0, a.A)(this, '_cachedRenderedAnnotation', null),
            (0, a.A)(this, '_objectURLs', {}),
            (0, a.A)(this, '_makeEnqueuedRelease', (e, t) => {
              if ('IMG' === e?.element?.tagName) {
                const n = e.element.src;
                if (!n) return;
                'number' == typeof this._objectURLs[n]
                  ? this._objectURLs[n]++
        ...
        getAnnotationFormFieldAndValue(e) {
          ...
          const n =
            e instanceof o.sb
              ? t._readStateCallbacks?.getFormFieldByName(e.formFieldName)
              : null;
          return {
            formField: n,
            formFieldValue:
        ...
        getAnnotationAvailableVariants(e) {
          ...
          return [
            ...(t._readStateCallbacks?.getAvailableVariants(e) || []),
            'normal',
          ];
        }
        cachedRenderAnnotation(e, t, n, a, i) {
          const o = this.provider;
          (0, s.V1)(
            o instanceof o.constructor,
            'Backend can only use backend annotation provider'
          );
          const { formField: c, formFieldValue: l } =
            this.getAnnotationFormFieldAndValue(e);
          if (!(0, r.lG)(e, c)) return this.renderAnnotation(e, l, t, n, a, i);
              ...
              try {
                ...
                if (!o) {
                  const t = new Promise((t) => {
                    this.annotationAPStreamPromises =
                      this.annotationAPStreamPromises.set(e.id, t);
                  });
                  return void s(await t);
                }
                await o;
                const c = this.cachedAPStreams.get(e.pageIndex);
                if (c) {
                  const t = c ? c.get(e.id) : null;
                  if (t) return void r(this.getAPStream(t, i));
                }
                const { promise: h, cancel: p } = this.renderAPStream(
                  e,
                  l,
                  t,
                  n,
        ...
        getAPStream(e, t) {
          return e instanceof c.A ? e : e?.[t || 'normal'] || null;
        }
        renderAPStream(e, t, n, a, i, s, o) {
          if (s.length > 1) {
            const o = s.map((s) =>
              this.renderAnnotation(e, t, n, a, i, 'normal' !== s ? s : void 0)
            );
            return {
              promise: o,
              cancel: () => {
          ...
          return this.renderAnnotation(e, t, n, a, i, o);
        }
        releaseAPStream(e) {
          e instanceof c.A
            ? e.release()
        ...
        isVisuallyIdenticalStampAnnotationCached(e) {
          let { annotation: t, width: n, height: a } = e;
          const i = (0, r.sS)(t);
          return (
            !!this._cachedRenderedAnnotation &&
            (0, l.bp)({
              annotation: t,
              annotationVisualPropertiesString: i,
              width: n,
              height: a,
              secondAnnotationVisualPropertiesString:
                this._cachedRenderedAnnotation.index,
        ...
        cachedStampAnnotationDiscardablePromise(e) {
          let { promise: t, resolve: n, reject: a } = e;
          (0, s.V1)(this._cachedRenderedAnnotation);
          const i = this._cachedRenderedAnnotation.index;
          return (
    ...
    92026: (e, t, n) => {
      ...
      var a = n(67136),
        ...
        F = n(74111),
        _ = n(78236);
      class v extends (0, i.mS)({
        alreadyLoadedPages: (0, i.T5)(),
        isLoaded: !1,
        isDestroyed: !1,
      }) {}
      const k = {
      ...
      class C {
        constructor(e, t) {
          (0, a.A)(this, '_state', new v()),
            ...
            (0, a.A)(this, '_commentsLoadedPromise', null),
            (0, a.A)(this, 'canCreateBackendOrphanWidgets', !1),
            (0, a.A)(this, 'updateTabOrderTimeout', null),
            (0, a.A)(this, 'pagesTabOrderToUpdate', (0, i.NZ)()),
            (this._core = e),
        ...
        createComment(e, t, n) {
          return this._core.applyComments(t.map((e) => I(e, n)).toArray());
        }
        updateComment(e, t, n) {
          return this._core.applyComments(t.map((e) => I(e, n)).toArray());
        }
        ...
        async _loadComments() {
          this._verifyLoaded();
          const e = (await this._core.getComments()) ?? [],
            t = (0, i.B8)(
              e.map((e) => {
                let t;
                return (
            ...
            t
              .map(
                (e) =>
                  ...
                  this.loadAnnotationsForPageIndex(e.pageIndex)
              )
              .filter(Boolean)
              .toArray()
          ),
        ...
        async updateTabOrder(e) {
          (this.pagesTabOrderToUpdate = this.pagesTabOrderToUpdate.add(e)),
            ...
            (this.updateTabOrderTimeout = setTimeout(async () => {
              ...
              if (
                ((this.pagesTabOrderToUpdate = (0, i.NZ)()),
                this._isDestroyed())
              )
                return;
              const t = await Promise.all(
                e.map((e) => this._core.getTabOrder(e))
              );
              this._isDestroyed() ||
                ((0, o.V1)(this._annotationCallbacks),
                (0, S.vA)(() => {
        ...
        async createAnnotation(e, t) {
          ...
          const n = t.find(
            ...
            a = await this._core.createAnnotation(
              (0, A.eq)(e),
              n ? n.data : null
            );
          'number' != typeof a ||
        ...
        async _loadFormFields() {
          ...
          let t = (0, i.B8)(),
            n = (0, i.B8)().withMutations((n) => {
              e.forEach((e) => {
                const { formField: a, widgets: i, value: s } = e;
                try {
                  let e;
          ...
          t.forEach((e) => {
            ...
            (t = t.map((e) => {
              if (
                (s[e.id].filter((t) => t !== e.pdfObjectId).length > 0 &&
                  e.pdfObjectId?.toString() !== e.id) ||
            ...
            Object.keys(a).forEach((e) => {
              ...
              const i = t
                ...
                .toArray()
                .map((e) => (0, A.eq)(e));
              this._core.updateFormField((0, A.T7)(a), i);
            }),
            n.size > 0 &&
              !this._isDestroyed() &&
              ((0, o.V1)(this._formFieldCallbacks),
              this._formFieldCallbacks.createFormFields(n, _.n)),
        ...
        async _loadAnnotationsForPageIndex(e) {
          ...
          const a = [],
            ...
            r = t
              .map((e) => {
                let { rollover: t, down: n, ...i } = e;
                return (
                  t &&
                    'number' == typeof i.pdfObjectId &&
                    a.push(i.pdfObjectId),
                  n &&
                    'number' == typeof i.pdfObjectId &&
                    s.push(i.pdfObjectId),
                  i
                );
              })
              .filter((e) => 'number' == typeof e.pageIndex);
          this._formFieldCallbacks && (await this.loadFormFields());
          const c = (0, i.B8)().withMutations((e) => {
            r.filter(
              (e) =>
                !e.id ||
        ...
        async _loadFormFieldValues() {
          ...
          if (this._isDestroyed()) return;
          const t = (0, i.B8)().withMutations((t) => {
            e.forEach((e) => {
              try {
                t.push((0, A.R5)(e));
              } catch (t) {
          ...
          t.size > 0 &&
            !this._isDestroyed() &&
            ((0, o.V1)(this._formFieldValueCallbacks),
        ...
        async loadBookmarks() {
          ...
          const t = (0, i.B8)().withMutations((t) => {
            e.forEach((e) => {
              let n;
              n = e.id ? e.id : e.pdfBookmarkId ? e.pdfBookmarkId : (0, F.z)();
              try {
                t.push((0, P.r)(n, e));
              } catch (e) {
                (0, o.pq)(
          ...
          t.size > 0 &&
            ...
            this._bookmarkCallbacks.createBookmarks(t, _.n));
        }
        _verifyLoaded() {
          (0, o.V1)(
      ...
      function I(e, t) {
        (0, o.V1)(e.rootId, 'A new comment must have `rootId` present');
        const n = t.get(e.rootId);
        return (
          (0, o.V1)(
            n,
          ...
          (0, A.wG)(
            e,
            n.pdfObjectId?.toString() === n.id ? parseInt(e.rootId) : e.rootId
          )
        );
      }
      class D {
      ...
      function Z(e) {
        return (
          'string' == typeof e?.serialNumber && e.body instanceof ArrayBuffer
        );
      }
      function ee(e) {
        return (
          e?.pkcs7 instanceof ArrayBuffer &&
          (!('ocspResponses' in e) ||
            (Array.isArray(e.ocspResponses) &&
              e.ocspResponses.every((e) => Z(e))))
        );
      }
      function te(e) {
        if (!e) return !1;
        const { signedData: t, timestampResponse: n, ocspResponses: a } = e;
        if (!(t instanceof ArrayBuffer)) return !1;
        if (n && !(n instanceof ArrayBuffer)) return !1;
        if (a) {
          if (!Array.isArray(a)) return !1;
          if (!a.every((e) => Z(e))) return !1;
        }
        return !0;
      }
      class ne {
        ...
        async signDocumentAndReload(e, t) {
          ...
          const i = {
            signatureType:
              n?.signatureType ||
              (Array.isArray(a) && a.length > 0 ? $.D7.CAdES : $.D7.CMS),
            ...(a && {
              certificates: a.map((e) =>
            ...
            ...(e?.placeholderSize
              ? { estimatedSize: e.placeholderSize }
              : null),
          };
          try {
            const {
                ...
                fileContents: c,
                dataToBeSigned: d,
              } = await this.backend.client.prepareSign(
                (0, A.Y6)(i),
                e?.signatureMetadata ? (0, A.sZ)(e.signatureMetadata) : null,
                Boolean(e?.flatten),
                e?.formFieldName,
                (0, A.qN)(e?.position),
                await (0, A.z8)(e?.appearance)
              ),
              u = (function (e) {
                const t = e.trim(),
                  n = t.length / 2,
                  a = new Uint8Array(n);
                for (let e = 0; e < n; e++)
                  a[e] = parseInt(t.substr(2 * e, 2), 16);
                return a;
              })(d);
            let m, h, p;
            if (t) {
              try {
                m = await t({ hash: a, fileContents: c, dataToBeSigned: u });
              } catch (e) {
                throw new o.uE(
                  `\`twoStepSignatureCallback\` threw an error: ${e}`
                );
              }
              if (!(m instanceof ArrayBuffer || ee(m) || te(m)))
                throw new o.uE(
                  `The resolved value from \`twoStepSignatureCallback\` should be a an \`ArrayBuffer\`, \`SignatureCallbackResponsePkcs7\`, or \`SignatureCallbackResponseRaw\`, but is of type \`${typeof m}\` instead.`
                );
              p = m;
            } else {
              if (!n?.privateKey)
                ...
                );
              {
                const e = {
                  ...
                  t = await globalThis.crypto.subtle.importKey(
                    'pkcs8',
                    (function (e) {
                      const t = e.split('\n');
                      let n = '';
                      for (let e = 0; e < t.length; e++)
                        t[e].trim().length > 0 &&
                          ...
                          (n += t[e].trim());
                      return l.o4.toUint8Array(n).buffer;
                    })(n.privateKey),
                    e,
                    !0,
                    ['sign']
            ...
            if (p instanceof ArrayBuffer)
              f = l.o4.fromUint8Array(new Uint8Array(p)) || '';
            else if (ee(p)) {
              const e = p;
            ...
            if (
              (n?.ltv &&
                (p instanceof ArrayBuffer
                  ? (b = await this.backend.getRevocationResponses(g))
                  : (ee(p) || te(p)) &&
                    ((0, o.V1)(
                      null == p.ocspResponses ||
                        (Array.isArray(p.ocspResponses) &&
                          p.ocspResponses.every((e) => Z(e))),
                      'The `ocspResponses` property of `signatureData` must be a array of `OCSPResponses`.'
                    ),
                    (b =
                      p.ocspResponses?.map((e) => ({
                        response_code: 200,
                        body: l.o4.fromUint8Array(new Uint8Array(e.body)),
                        token: e.serialNumber,
                      })) ?? []),
                    b.length ||
                      ((0, o.R8)(
                        "The `TwoStepSignatureCallback` didn't return certificate revocation responses; trying to fetch them online."
                      ),
                      (b = await this.backend.getRevocationResponses(g))))),
              te(p))
            ) {
            ...
            if (!y && n?.timestamp && p instanceof ArrayBuffer) {
              ...
              y = await this.backend.timestampData(e, n.timestamp);
            }
            const S = await this.backend.client.sign(
              r,
              s,
              a,
              A.xz[i.signatureType],
              f,
              g,
              ee(p)
                ? 'pkcs7'
            ...
            return (
              n?.ltv &&
                S.signature.certificateChainValidationStatus ===
              ...
              await this.backend.reloadDocument(),
              s
            );
          } catch (e) {
            throw (await this.backend.client.restoreToOriginalState(), e);
          }
        }
      }
      var ae = n(40527);
      class ie extends ne {
        ...
        async signDocumentAndReload(e, t) {
          ...
          const { jwt: n, signingToken: a } = t,
            ...
            r = this.signatureCallbackFactory(i, n, s, e, t);
          return await super.signDocumentAndReload(
            {
              ...e,
              signingData: {
                ...e?.signingData,
                signatureType: e?.signingData?.signatureType || $.D7.CAdES,
                certificates: s,
              },
            },
            r
        ...
        async getCertificates(e, t, n) {
          let a;
          try {
            a = await fetch(`${e}/api/get_certificates`, {
              method: 'POST',
              headers: {
              ...
              body: JSON.stringify({ signingToken: n }),
            });
          } catch (t) {
            throw new o.uE(
              `The signing service failed to retrieve certificates: Failed to fetch from ${e}/api/get_certificates`
            );
          }
          if (!a.ok)
            throw new o.uE(
              `The signing service failed to retrieve certificates: ${await a.json()}`
            );
          const i = (await a.json())?.data || {};
          return i.certificates
            .concat(i.ca_certificates)
            .map((e) => l.o4.fromBase64(e));
        }
        resolveServerUrl(e) {
          const t =
            e.serverUrl ||
            (function (e) {
              try {
                const t = e.split('.');
                if (3 !== t.length) throw new o.uE('Invalid JWT token format');
                const n = l.o4.decode(t[1]);
                return JSON.parse(n);
              } catch (e) {
                throw new o.uE(`Invalid auth token: ${e.message}`);
              }
            })(e.jwt).server_url;
          return (
            (0, o.V1)(
              t,
              '`twoStepSignatureCallbackOrStandaloneSigningServiceData.jwt` must contain claim `server_url` or the `twoStepSignatureCallbackOrStandaloneSigningServiceData.serverUrl` should be set'
            ),
            t
          );
        }
        signatureCallbackFactory(e, t, n, a, i) {
          return async (s) => {
            let r,
              { hash: c, dataToBeSigned: d } = s;
            try {
              r = await fetch(`${e}/api/sign_hash`, {
                method: 'POST',
                headers: {
                  Authorization: `Bearer ${t}`,
                  Accept: 'application/json',
                ...
                credentials: 'same-origin',
                body: JSON.stringify({
                  dataToBeSigned: l.o4.fromUint8Array(d),
                  hash: c,
                  signatureType: a?.signingData?.signatureType || $.D7.CAdES,
                  signingToken: i.signingToken,
                  cadesLevel: a?.signingData?.padesLevel || $.sX.b_lt,
                }),
              });
            } catch (t) {
              throw new o.uE(
            ...
            if (!r.ok)
              throw new o.uE(
                `The signing service failed to sign: ${await r.text()}`
              );
            const u = (await r.json())?.data || {};
            if (a?.signingData?.signatureContainer === $.Yj.pkcs7) {
              const e = { pkcs7: l.o4.toUint8Array(u.pkcs7).buffer };
              return (
                u.ocspResponses &&
                  (e.ocspResponses = u.ocspResponses.map((e) => ({
                    serialNumber: e.serialNumber,
                    body: l.o4.toUint8Array(e.body).buffer,
                  }))),
                e
              );
            }
            {
              const e = {
                certificates: n,
                signedData: l.o4.toUint8Array(u.signedData).buffer,
                timestampResponse: l.o4.toUint8Array(u.timestampResponse)
                  .buffer,
              };
              return (
                u.ocspResponses &&
      ...
      class re extends g.K {
        constructor(e) {
          ...
          const {
            ...
            instantJSON: s,
            XFDF: o,
            enableAutomaticLinkExtraction: c,
            overrideMemoryLimit: l,
            trustedCAsCallback: u,
            electronAppName: m,
            appName: h,
            isSharePoint: p,
            isSalesforce: f,
          ...
          'string' == typeof o &&
            ...
            s &&
              s.annotations &&
              (s.annotations = s.annotations.map(
                (e) => ((e.id = e.id?.toString()), e)
              )),
            (this._instantJSON = s),
          ...
          const {
            ...
            { standaloneInstancesPoolSize: k } = e;
          void 0 !== k && (oe.size = k);
          const I =
          ...
          (!p && !f) || D || (D = p ? W.v.SharePoint : W.v.Salesforce),
            (this._state = new V(
              ce({
                ...
                customFonts: _,
                fontSubstitutions: v,
                forceLegacySignaturesFeature: I,
                appName: h || m,
                productId: D,
                processorEngine: b || G.j.fasterProcessing,
                dynamicFonts: A,
                inlineWorkers: S,
                allowLinearizedLoading: w,
              })
          ...
          const O = s
            ...
            : null;
          this.provider = new C(this.client, O);
        }
        ...
        async lazyLoadPages() {
          if (!this._state.lazyLoadedPages) {
            const e = await this.client.getAllPageInfos(
        ...
        textForPageIndex(e) {
          return this.corePDFBridge.getTextLines(e);
        }
        getContentTreeForPageIndex(e) {
          return this.corePDFBridge.getContentTree(e);
        }
        ...
        async getSuggestedLineHeightFactor(e) {
          return 'number' != typeof e.pdfObjectId
            ? 1
            : 'number' != typeof e.pageIndex
              ? ((0, o.R8)('Annotation must have a pageIndex.'), 1)
              : (e.lineHeightFactor &&
                  (0, o.R8)(
                    `Annotation ${e.id} already has a line height factor.`
                  ),
        ...
        renderAnnotation(e, t, n, a, i, s) {
          ...
          const o = (0, Q.yl)();
          if (e instanceof K.xY) {
            if (
              this.isVisuallyIdenticalStampAnnotationCached({
                annotation: e,
                width: a,
                height: i,
              })
          ...
          const r = e.id,
            c = new D(r, () =>
              this.client
                .renderAnnotation((0, A.eq)(e), n, a, i, (0, N.LG)(), s)
                .then((e) =>
                  e
                    ? 'string' == typeof e
                      ? (0, h.$3)(e)
                      : (0, h.vB)({ buffer: e, width: a, height: i })
                    : Promise.resolve(null)
                )
                .then(
                  (t) => (
                    e instanceof K.xY &&
                      this._makeEnqueuedRelease(t, (0, f.sS)(e)),
                    o.resolve(t),
                    t
                  )
                )
            );
          return this._requestQueue.enqueue(c, !1);
        }
        ...
        async renderPageAnnotations(e, t, n) {
          const a = this.provider,
            i = [],
            s = [],
            o = t.some((e) => e instanceof K.sb);
          o && (await a._setReadStateCallbacksPromise);
          const r = t.filter((e) => {
            const t = (
                o
                  ? a._readStateCallbacks.getAnnotationWithFormField(e.id)
                  : null
              )?.formField,
              n = (0, f.lG)(e, t);
            if (n && t) {
              i.find((e) => e.name === t.name) ||
                (i.push((0, A.cA)((0, O.Af)(t))), s.push(t));
            }
            return n;
          });
          function c(e, t) {
                  ...
                  e.forEach((e, t) => {
                    ...
                    if (a) {
                      const { formFieldValue: t } =
                          this.getAnnotationFormFieldAndValue(a),
          ...
          return (
            (this.pageAPStreamsPromises = this.pageAPStreamsPromises.set(e, l)),
            l
          );
        }
        renderDetachedAnnotation(e, t, n, a) {
          if (e.id)
            throw new o.uE(
              `Detached annotations should not have an \`id\`: ${e.id}`
            );
          const i = (0, Q.yl)();
          if (e instanceof K.xY) {
            if (
          ...
          const s = (0, c.Z0)(),
            r = new D(s, () =>
              this.client
                .renderDetachedAnnotation((0, A.eq)(e), t, n, a, (0, N.LG)())
                .then((e) =>
                  e
                    ? (0, h.vB)({ buffer: e, width: n, height: a })
                    : Promise.resolve(null)
                )
                .then(
                  (t) => (
            ...
            { promise: l, cancel: d } = this._requestQueue.enqueue(r, !1);
          return { promise: l, cancel: d };
        }
        ...
        async parseXFDF(e, t) {
          ...
          return {
            ...
            formFieldValues: a?.reduce(
              (e, t) => ((e[t.fqdn] = t.values), e),
              {}
            ),
            annotations: (0, i.B8)(
              s?.map((e) => (0, A.h8)((0, f.K1)(), e)) || []
            ),
          };
        }
        async search(e, t, n, a) {
          ...
          return (0, b.g)(o.filter((e) => i || !e.isAnnotation));
        }
        async searchAndRedact(e, t, n) {
          const { totalPages: a } = n,
            s = await this.client.search(
              e,
              t.startPageIndex ?? 0,
              t.pageRange ?? a,
              t.caseSensitive,
            ...
            s
              ...
              .map((e) => {
                const a = e.isAnnotation ? [e.annotationRect] : e.rectsOnPage,
                  s = (0, i.B8)(a).map((e) => ((0, o.V1)(e), (0, U.a)(e)));
                return new B.A({
                  ...(0, f.mN)(n),
                  ...t.annotationPreset,
                  pageIndex: e.pageIndex,
                  rects: s,
                  boundingBox: R.A.union(s),
                });
              })
          );
        }
        async exportPDF() {
          let {
              ...
              permissions: r,
              outputFormat: c = !1,
              flattenElectronicSignatures: l = e,
          ...
          if (
            (c &&
              ...
              c.conformance &&
              (0, o.V1)(
                c.conformance && Object.values(J.o).includes(c.conformance),
                'The supplied PDF/A Conformance type is not valid. Valid Conformance should be one of the following options PSPDFKit.Conformance.' +
                  Object.keys(J.o).join(', PSPDFKit.Conformance.')
              ),
            void 0 === t)
          )
            if (this._state.features.includes(q.Y.DIGITAL_SIGNATURES)) {
              const e = await this.getSignaturesInfo();
              t = !n && Boolean('not_signed' !== e.status);
            } else t = !1;
          return this.client
            .exportFile(e, t, n, a, i, s, r, d)
            .then(async (e) => {
              let [t, n] = e;
              if (((t.mimeType = n.mimeType), (t.extension = n.extension), c)) {
                const e =
                ...
                try {
                  return (
                    (n = await this._setupGdPictureClient()),
                    await n.toPdf(t, e)
                  );
                } finally {
          ...
          return (
            e ||
              ((e = (0, X.NY)({
                ...
                mainThreadOrigin:
                  this._state.appName || (0, u.D5)() || window.location.origin,
        ...
        async getDocumentOutline() {
          ...
          return (0, i.B8)(e.map(p.r));
        }
        async setDocumentOutline(e) {
          return this.client.setDocumentOutline(e.map(p.U).toArray());
        }
        ...
        async evalFormValuesActions(e) {
          return this.client.evalFormValuesActions(e.map(A.cA).toJS());
        }
        ...
        async getMeasurementScales() {
          return (await this.client.getMeasurementScales())
            ?.measurementContentFormats;
        }
        ...
        async applyOperationsAndReload(e) {
          try {
            const { processedOperations: t, operationsDocuments: n } =
              await de(e);
            await this.client.applyOperations(t, n);
          } catch (e) {
            throw new o.uE(`Applying operations failed: ${e}`);
          }
          return (
        ...
        async applyRedactionsAndReload() {
          try {
            ...
            throw new o.uE(`Applying redactions failed: ${e}`);
          }
        ...
        async reloadDocument() {
          try {
            ...
            throw new o.uE(`Reloading failed: ${e}`);
          }
        }
        ...
        async exportPDFWithOperations(e) {
          try {
            ...
            throw new o.uE(`Exporting PDF with operations failed: ${e}`);
          }
        }
        async setSignaturesLTV(e) {
          try {
            const t = (e ?? []).map((e) =>
              ...
              n = await this.getRevocationResponses(t);
            if (
              (
                await this.client.setSignaturesLTV(n).then((e) => (0, A.N5)(e))
              ).signatures?.find(
                (e) =>
                  e.certificateChainValidationStatus ===
                  $.k5.ok_but_could_not_check_revocation
              )
            )
            ...
            throw new o.uE(`Setting signatures LTV failed: ${e}`);
          }
        }
        getSignaturesInfo() {
          try {
            ...
            t.map(async (e) => {
              ...
              try {
                const e = await fetch(n, {
                    method: t,
                    headers: {
                      'Content-Type': a ?? 'application/ocsp-request',
                    },
                    body: l.o4.toUint8Array(i).buffer,
                  }),
                  o = await e.arrayBuffer();
                return {
                  response_code: e.status,
                  body: l.o4.fromUint8Array(new Uint8Array(o)),
                  token: s,
                };
              } catch (e) {
                return {
        ...
        async signDocumentAndReload(e, t) {
          (0, o.V1)(
            void 0 === t || 'function' == typeof t || (0, ae.kJ)(t),
            'On a Standalone deployment, `twoStepSignatureCallbackOrSigningServiceData` must be a function or `PSPDFKit.StandaloneSigningServiceData` if provided.'
          );
          const n = (0, ae.kJ)(t);
          return n
            ? this.signingServiceDocumentSigner.signDocumentAndReload(e, n)
            : this.standaloneDocumentSigner.signDocumentAndReload(e, t);
        }
        cancelRequests() {
        ...
        async openComparisonDocument(e) {
          return (
            ...
            (await this.client.openComparisonDocument(e)) ||
        ...
        async runPDFFormattingScriptsFromWidgets(e, t, n) {
          ...
          if (this._isPDFJavaScriptEnabled) {
            const { withAPStream: i, withoutAPStream: s } = e.reduce(
              (e, a) => {
                if (a instanceof K.sb) {
                  const i = t?.get(a.formFieldName);
                  if (i instanceof K.Vw) return e;
                  n?.(a)
            ...
            if (i.length && !s.length)
              o = await this.runPDFFormattingScripts(i, !0);
            ...
            a = (0, O.A5)(this._initialChanges, o);
          }
          return a;
        }
        ...
        updateButtonIcon(e, t, n) {
          return this.client.updateButtonIcon((0, A.eq)(e), t, n);
        }
        async timestampData(e, t) {
          const { url: n, username: a = '', password: i = '' } = t,
            s = l.o4.fromUint8Array(new Uint8Array(e));
          try {
            const e = await this.client.getTimestampRequest(s, {
                url: n,
                username: a,
                password: i,
              }),
              t = {
                ...
                headers: {
                  'Content-Type':
                    e.contentType || 'application/timestamp-query',
                },
                body: l.o4.toUint8Array(e.requestData).buffer,
              };
            (e.username || e.password) &&
              (t.headers.Authorization = `Basic ${btoa(`${e.username}:${e.password}`)}`);
            try {
              const n = await fetch(e.url, t),
                a = await n.arrayBuffer();
              return {
                response_code: n.status,
                body: l.o4.fromUint8Array(new Uint8Array(a)),
                token: e.token,
              };
            } catch (t) {
              return {
      ...
      function ce(e) {
        return {
          ...
          overrideMemoryLimit:
            'number' == typeof e.overrideMemoryLimit
              ? e.overrideMemoryLimit
              : null,
          documentHandle:
            'number' == typeof e.documentHandle ? e.documentHandle : '0',
          trustedCAsCallback:
            'function' == typeof e.trustedCAsCallback
              ? e.trustedCAsCallback
              : null,
          customFonts: Array.isArray(e.customFonts)
            ? e.customFonts.filter((e) => e instanceof z.A)
            : null,
          ...
          allowLinearizedLoading: e.allowLinearizedLoading,
        };
      }
      function le(e) {
        const {
          ...
          disableIndexedDBCaching: s,
          enableAutomaticLinkExtraction: r,
          overrideMemoryLimit: c,
          standaloneInstancesPoolSize: l,
        ...
        if (
          ...
          (0, o.V1)(
            void 0 === p ||
              (Array.isArray(p) && p.every((e) => e instanceof z.A)),
            ...
            e.map(async (e, a) => {
              ...
              if ('applyInstantJson' === e.type) {
                ...
                const s = JSON.stringify(i),
                  r = new Blob([s], { type: 'application/json' });
                return (0, L.g)(t, n, r, e, a, 'dataFilePath');
              }
              if ('applyXfdf' === e.type) {
                const i = e.xfdf;
                (0, o.V1)(
                ...
                const s = new Blob([i], { type: 'application/vnd.adobe.xfdf' });
                return (0, L.g)(t, n, s, e, a, 'dataFilePath');
              }
              return e;
            })
          ),
      ...
      function r(e, t) {
        ...
        return o(0, n)
          ? new i({
              ...
              updatedAt: t.modificationDate
                ? new Date(t.modificationDate)
                : null,
            })
          : new i({
              id: e,
    ...
    41477: (e, t, n) => {
      ...
      function c(e) {
        return {
          ...
          title: e.title,
          color: e.color && (0, o.J)(e.color),
          isBold: e.isBold,
          isItalic: e.isItalic,
          isExpanded: e.isExpanded,
          action: e.action && (0, s.Ix)(e.action),
        };
      }
      function l(e) {
        let t, n;
        (0, a.V1)(
          ...
          (0, a.V1)('string' == typeof e.title, 'title must be a string.'),
          (0, a.V1)(
            null == e.isBold || 'boolean' == typeof e.isBold,
            'isBold must be a boolean.'
          ),
          (0, a.V1)(
        ...
        try {
          ...
          (0, a.R8)(`PDF Action not supported ${JSON.stringify(e.action)})`);
        }
        try {
          n = e.color && (0, o.p)(e.color);
        } catch (t) {
          (0, a.R8)(`Invalid color:\n\n${e.color}`);
        }
        const c = {
          title: e.title,
          color: n,
        ...
        return (
          e.children &&
            e.children.length > 0 &&
            (c.children = (0, i.B8)(e.children.map(l))),
          new r.LC(c)
        );
      }
    },
    ...
    47159: (e, t, n) => {
      ...
      function r(e) {
        return (
          (0, i.V1)(Array.isArray(e), 'Wrong `json` field'),
          (0, a.B8)(
            e
              .map(
                (e) => (
                  ...
                  (0, i.V1)(
                    'string' == typeof e.previewText,
                    'Wrong `previewText` field'
                  ),
                  (0, i.V1)(
                    Array.isArray(e.rangeInPreview),
                    'Wrong `rangeInPreview` field'
                  ),
                  (0, i.V1)(
                    Array.isArray(e.rectsOnPage),
                  ...
                  new o.A({
                    ...
                    rectsOnPage: (0, a.B8)(e.rectsOnPage).map((e) =>
                      (0, s.a)(e)
                    ),
                    isAnnotation: !!e.isAnnotation,
                    annotationRect: e.annotationRect
                      ? (0, s.a)(e.annotationRect)
                      : null,
                  })
                )
              )
