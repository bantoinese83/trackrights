...
export const metadata: Metadata = {
  ...
  description:
    'TrackRights uses AI to simplify and explain music contracts in plain language. Perfect for artists, producers, songwriters, managers, and all music industry professionals. Understand complex legal jargon effortlessly.',
  keywords: [
