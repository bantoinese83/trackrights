...
(globalThis.webpackChunkPSPDFKit = globalThis.webpackChunkPSPDFKit || []).push([
  ...
  {
    33393: (a, t, e) => {
      e.d(t, { RESTProvider: () => m });
      var s = e(67136),
        o = e(49568),
        i = e(85409),
        n = e(97881),
        r = e(82987);
      class d extends o.mS({
        alreadyLoadedPages: (0, o.T5)(),
        serverURL: null,
        authPayload: null,
        isLoaded: !1,
        isFormsEnabled: !0,
      ...
      class m {
        ...
        async createAnnotation(a, t) {
          this._verifyLoaded();
          const { id: e, ...s } = (0, n.eq)(a),
            o = { id: e, content: s },
            r = await this._request('/annotations', 'POST', o);
          if (200 !== r.status)
            throw new i.uE(
              'PSPDFKit Document Engine returned an error, when saving an annotation.'
            );
          if ('attachment_missing' === (await r.json()).error) {
            ...
            if (200 !== (await this._request('/annotations', 'POST', a)).status)
              throw new i.uE(
                'PSPDFKit Document Engine returned an error, when saving an annotation attachment.'
              );
          }
        }
        async updateAnnotation(a) {
          this._verifyLoaded();
          const { id: t, ...e } = (0, n.eq)(a);
          await this._request(`/annotations/${t}`, 'PUT', {
            id: t,
            content: e,
          });
        }
        ...
        async createBookmark(a) {
          ...
          if (
            200 !==
            (await this._request('/bookmarks', 'POST', { id: t, content: e }))
              .status
          )
            throw new i.uE(
              'PSPDFKit Document Engine returned an error, when saving an bookmark.'
            );
        }
        ...
        async setFormFieldValue(a) {
          this._verifyLoaded();
          const t = { id: (0, l.B)(a), content: (0, n.cA)(a) };
        ...
        async loadAnnotationsForPageIndex(a) {
          if ((this._verifyLoaded(), this.state.alreadyLoadedPages.has(a)))
            await this.state.alreadyLoadedPages.get(a);
          else
            try {
              ...
              this.state = this.state.setIn(
                ['alreadyLoadedPages', a],
                Promise.resolve()
              );
              const s = (0, o.B8)().withMutations((a) => {
              ...
              s.size > 0 &&
                ((0, i.V1)(this.annotationCallbacks),
        ...
        async loadBookmarks() {
          if ((this._verifyLoaded(), this.state.loadBookmarksPromise))
            ...
            try {
              ...
              e.size > 0 &&
                ((0, i.V1)(this.bookmarkCallbacks),
                this.bookmarkCallbacks.createBookmarks(e, c.n));
            } catch (a) {
        ...
        async _initializeFormFieldValues() {
          const a = await this._request('/form-field-values', 'GET'),
            t = await a.json();
          (0, i.V1)(
            Array.isArray(t.formFieldValues),
        ...
        async updateTabOrder() {
          throw new i.uE('Tab order is not supported on this backend.');
        }
        async setTabOrder() {
          throw new i.uE('setTabOrder is not supported on this backend.');
        }
      }
    },
  },
