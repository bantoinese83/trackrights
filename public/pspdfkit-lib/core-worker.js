...
!(function (e, t) {
  ...
  (() => {
    var e = {
        ...
        51605: (e, t, n) => {
          ...
          e.exports = function (e, t) {
            var n,
              ...
              g = e.global,
              h = e.stat;
            if ((n = g ? r : h ? r[m] || s(m, {}) : (r[m] || {}).prototype))
              for (u in t) {
                if (
                  ((p = t[u]),
              ...
              : O && O.now
                ...
                : S && !y
                  ...
                  : s.addEventListener &&
                      ...
                      'file:' !== r.protocol &&
                      !p(k)
                    ? ((o = k), s.addEventListener('message', P, !1))
                    : (o =
                        A in g('script')
                          ? function (e) {
        ...
        55480: () => {},
        97967: (e) => {
          e.exports = '8c19c958f517e8a3';
        },
        80658: (e) => {
          e.exports = 'ddcc88b7de1cd562';
        },
      },
      t = {};
    function n(r) {
    ...
    return (
      (() => {
        ...
        new WeakMap();
        const u = 'function' == typeof Buffer,
          d =
        ...
        const k = P,
          C = 'pspdfkit-lib/',
          T = `${C}pspdfkit${'-' + A()}.wasm.js`,
          N = `${C}pspdfkit${'-' + I()}.wasm`;
        function B(e, t) {
          let n;
          if ('object' == typeof e) {
            n = e.wasm;
            return { wasmBinaryFile: N, locateFile: (e) => e, wasmBinary: n };
          }
          const r = {
            wasmBinaryFile: e + N,
            locateFile: (e) => e,
          ...
          };
          {
            ...
            e
              .then((e) => {
                ...
                return (
                  t &&
                    parseInt(t) >= n &&
                    i(
                      "The WASM binary file is being served without compression. Due to its size, it's recommended to configure the server so application/wasm files are served with compression.\n\nFind more details in our Standalone performance guides: https://pspdfkit.com/guides/web/best-practices/caching-on-the-web/#gzip-and-brotli"
                    ),
                  e
                );
              })
              ...
              (r.instantiateWasm = (n, i) => (
                (async () => {
                  o(`Start ${r.wasmBinaryFile} download.`);
                  const s = Date.now();
                  let c, l;
                  const u =
                    !t && 'function' == typeof WebAssembly.instantiateStreaming;
                  function d() {
                    return e
                      .then((e) => {
                        if (!e.ok)
                          throw new Error(
                            `Error loading ${r.wasmBinaryFile}: ${e.statusText}`
                          );
                      ...
                      .then(
                        (e) => (
                          (l = Date.now()),
                          o(`Download complete, took: ${l - s}ms`),
                          WebAssembly.instantiate(new Uint8Array(e), n)
                        )
                      );
                  }
                  c = u
                    ? WebAssembly.instantiateStreaming(e, n)
                        .then(
                          (e) => (
                            (l = Date.now()),
                            o(
                              `Download and Instantiation complete, took: ${Date.now() - s}ms`
                            ),
                            e
                          )
                        )
          ...
          (e.PSPDFLoggingServices = {
            ...
            (e.PSPDFUnicodeServices = {
              stripDiacritics(e) {
                ...
                const n = e.replace(/[^A-Za-z0-9[\] ]/g, function (e) {
                  return t[e] || e;
                });
                return e.normalize('NFC').length == n.normalize('NFC').length
                  ? n
                  : '';
              },
              escapeRegExp: (e) => e.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'),
              match(e, t, n) {
                const r = new RegExp(t, n ? 'g' : 'gi'),
                  o = [];
                let i = r.exec(e);
                for (; null != i; )
        ...
        async function X(e) {
          try {
            const n = await fetch(e).catch((n) => {
              throw new t(`Error fetching dynamic fonts file ${e}. ${n}`);
            });
            if (200 !== n.status)
              throw new t(
                `Error fetching dynamic fonts file ${e}. Status code: ${n.status}`
              );
            return n;
          } catch (e) {
            throw e;
        ...
        function ee(e, t) {
          ...
          let r;
          return (r = e.match(n)) ? Number(r[1]) : 0;
        }
        function te() {
          let e =
              arguments.length > 0 && void 0 !== arguments[0]
          ...
          return t.indexOf('MacIntel') > -1 && n > 1
            ? 'ios'
            : e.indexOf('Win') > -1
              ? 'windows'
              : e.indexOf('iPhone') > -1 ||
        ...
        function oe() {
          ...
          return (
            ('undefined' == typeof window ||
              !window.PSPDFKIT_PLAYWRIGHT_TEST) &&
            'webkit' === e &&
        ...
        const se = '/create.pdf',
          ce = '/save.pdf',
          le = '/embedded.pdf',
          ue = 'WebAssembly module not loaded.';
        let de = null,
          pe = !1,
          fe = !1,
          me = null;
        const ge = { password: void 0, initialPageIndex: void 0 };
        let he = [],
          ye = ge,
          be = null,
          we = null;
        ...
        const Ae = [
            'configurePDFJavaScriptSupport',
            'closeDocument',
            'setFormValues',
            'openDocument',
            'saveDocument',
            'importXFDF',
            'importInstantDocumentJSON',
          ],
          je = {
        ...
        function De(e) {
          ...
          for (
            ...
            o[i - 1] = arguments[i];
          const a = o.map((e) => (Ee(e) ? JSON.stringify(e) : e));
          Ae.includes(e) && Ue();
          const s = de[e](...a) || '{ "success": true }',
            c = JSON.parse(s);
          if (
            (Se &&
              Ie.push({
        ...
        const ke = [
          'run_pdf_formatting_scripts',
          'run_pdf_javascript',
          'set_form_values_get_script_changes',
          'edit_document',
          'prepare_sign',
          'sign',
          'on_keystroke_event',
        ...
        function Te(e, t) {
          let n =
            arguments.length > 2 && void 0 !== arguments[2]
              ...
              : null;
          r(de, 'WebAssembly module not loaded.');
          const o = JSON.stringify({ type: e, ...t });
          let i, a;
          if ((Se && (i = performance.now()), ke.includes(e) && Ue(), n))
            try {
              const e =
                  'string' == typeof n
                    ? new Uint8Array(Ce(n))
                    : new Uint8Array(n),
                t = de.allocateMemory(e.byteLength);
              try {
                t.view.set(e);
                const n = de.memoryHandleToVector(t);
                try {
                  a = de.dispatchCommandWithBinary(o, n);
                } finally {
                  n.delete();
                }
              } finally {
        ...
        async function Be(e, t) {
          const n = Math.random().toString(36).slice(-5),
            o = await Promise.all(
              Object.entries(t).map(async (t) => {
                ...
                return (
                  e.forEach((e) => {
                    'document' in e &&
                    e.document === r &&
                    'importDocument' === e.type
                      ? (!1 === e.treatImportedDocumentAsOnePage &&
                          (e.treatImportedDocumentAsOnePage = void 0),
                        (e.document = Ne(n, r)))
                      : (('dataFilePath' in e &&
                          e.dataFilePath === r &&
                          'applyInstantJson' === e.type) ||
                          ('dataFilePath' in e &&
                            e.dataFilePath === r &&
                            'applyXfdf' === e.type)) &&
                        (e.dataFilePath = Ne(n, r));
                  }),
                  { basename: r, buffer: await M(o) }
                );
              })
            );
          return (
        ...
        function $e() {
          fe = !0;
          const e = De('configurePDFJavaScriptSupport', !0);
          return (
            r(
              e.success,
              'An error occurred while executing the document level JavaScript.'
            ),
            e.changes || []
          );
        }
        function Me(e, t) {
          let n;
          try {
            n = Te('edit_document', { save_path: t, operations: e });
          } catch (e) {
            throw new Error(
              `Error applying operations to document: ${e.message}`
            );
          }
          return n;
        }
        ...
        function We() {
          return (
            null === Re &&
              ((Re = Te('read_form_json_objects', {
                include_line_height_factor: !1,
              })),
              (Je = !1)),
            Re
          );
        ...
        function qe(e, t, n, o, i, a) {
          const s = Ge(i, { width: n, height: o });
          if (
            (r(
              'number' == typeof e.pageIndex,
              'Annotation must have a pageIndex'
            ),
            !ve.has(e.pdfObjectId))
          )
            try {
              r(
                'number' == typeof e.pdfObjectId,
                'Cannot call renderAnnotation() for an annotation without pdfObjectId.'
              );
              const t = Te('render_annotation', {
                page: e.pageIndex,
        ...
        function Ge(e, t) {
          ...
          return ('webp' === e && (n > 16383 || r > 16383)) ||
            (re && n * r > 16777216 && 'bitmap' === e)
            ? 'png'
            : e;
        }
        function Ze(e) {
          const t = [];
          for (let n = 0; n < e.length; n++) t.push(je[e[n]]);
          return t;
        }
        function He(e, t) {
        ...
        const Ye = new (class {
            ...
            loadNativeModule(e, t) {
              ...
              return (
                ...
                (function (e, t) {
                  ...
                  de = t;
                  const n = De('PSPDFKitVersion').version;
                  if (1 !== n)
                    throw new Error(
                      `Native version mismatch. Please update the dependencies. Expected 1 but got ${n}.`
                    );
                })
              );
            }
            corePBProtoBridge(e, t, n) {
              const r = de.allocateMemory(n.byteLength);
              let o = null,
                i = null;
              try {
                r.view.set(n),
            ...
            async load(e, t, n) {
              ...
              try {
                if (
                  (de.FS.analyzePath(_e).exists || de.FS.mkdir(_e),
                  (Oe = s ? '/fonts/custom-fonts' : ''),
                  s &&
                  ...
                  ae() &&
                    (r(
                      null == l || l === G,
                      `PSPDFKit is running on Electron, but has been setup to be used with ${l}Please contact support to resolve the issue.`
                    ),
                    (l = G)),
                  (i = de.initPSPDFKit(
                    null == t ? '' : t,
              ...
              if (
                (be &&
                  o(
                    `Native initialization complete, took: ${Date.now() - be}ms`
                  ),
                !u.success)
              )
                throw new Error('Failed to initialize PSPDFKit: ' + u.error);
              return u;
            }
            getNativeModule() {
              return de;
            }
            async openDocument(e, t) {
              try {
                return (
                  r(de, ue),
                  null !== me && De('overrideMemoryLimit', me),
                  de.FS.writeFile(se, new Uint8Array(e)),
                  this.openAndReturnDocumentInfo(t ?? ge)
                );
              } finally {
                this._pdfObjectIdsForIds = {};
              }
            }
            async openCreateFilePathDocument(e) {
              try {
                return (
                  null !== me && De('overrideMemoryLimit', me),
                  this.openAndReturnDocumentInfo(e ?? ge)
                );
              } finally {
                this._pdfObjectIdsForIds = {};
              }
            ...
            async getSuggestedLineHeightFactor(e, t) {
              return Te('get_suggested_line_height_factor', {
                annotation_ids: [e],
                page: t,
            ...
            async getAvailableFontFaces(e) {
              if (!e) return [];
              return Te('get_available_font_faces')[0]?.font_faces.reduce(
                (t, n) => {
                  const r = e.find(
                    (e) => e.name === n.path.replace(`${Oe}/`, '')
                  );
                  return r
                    ? t.concat({ readableName: n.fullName, name: r.name })
                    : t;
                },
                []
              );
            ...
            async setFontSubstitutions(e) {
              try {
                Te('set_font_substitutions', { substitutions: e });
              } catch (e) {
                throw new Error(
                  'Error setting fonts substitutions: ' + e.message
                );
              }
            }
            async getClosestSnapPoint(e, t) {
              return Te('get_closest_snap', { q: [e, t] })[0];
            }
            async configureSnapper(e) {
              Te('configure_snapper', { page: e });
            }
            async reloadDocument() {
              try {
                return (
                  ze(!1),
                  De('closeDocument'),
                  this.openAndReturnDocumentInfo(ye)
                );
              } finally {
                this._pdfObjectIdsForIds = {};
              }
            ...
            async openAndReturnDocumentInfo(e) {
              ...
              let n = [];
              if ('number' == typeof e?.initialPageIndex) {
                const r = await this.getPageInfo(e.initialPageIndex);
                for (let o = 0; o < t.pageCount; o++) {
                  const t = {
                    ...r,
                    pageIndex: o,
                    pageLabel:
                      e.initialPageIndex === o ? r.pageLabel : String(o + 1),
                  };
                  n.push(t);
                }
            ...
            async getPageInfo(e) {
              try {
                const t = Te('page_info', { query: 'page_info', page: e });
                r(
                  1 === t.length,
                  'expected page_info result to return 1 result when specifying index.'
                );
                const n = new TextDecoder().decode(t[0]);
                return JSON.parse(n).pageInfo;
              } catch (t) {
                return (
                  a(
                    `Dimensional information for page ${e} unavailable, page will not be displayed.`
                  ),
                  {
                    height: 0,
                    matrix: [0, 0, 0, 0, 0, 0],
            ...
            async preflightRenderAnnotationText(e, t, n, o) {
              const i = () =>
                'number' == typeof t && 'number' == typeof n
                  ? Te('dynamic_font_loading/preflight_annotation', {
                      text: e,
                      annotation_id: t,
                      page: n,
                    })[0]
                  : (r(o, `annotation not set: ${o}`),
                    Te('dynamic_font_loading/preflight_annotation', {
                      text: e,
                      annotation_json: o,
                    })[0]);
              ...
              try {
                ...
                !(function (e) {
                  ...
                  (
                    await Promise.all(
                      t.map((e) =>
                        fetch(`${we}/${e}`).then((e) => e.arrayBuffer())
                      )
                    )
                  ).map((e, n) => ({ name: t[n], data: e }))
                ),
                  t.forEach((e) => {
                    Fe.add(e);
                  });
            ...
            async getAllPageInfos(e) {
              const t = [];
              try {
                const n = Te('page_info', { query: 'page_info', page: 'all' });
                r(
                  n.length === e,
                  'expected the same length of page info response to page count.'
                );
                for (let e = 0; e < n.length; e++) {
                  const r = new TextDecoder().decode(n[e]),
                    o = JSON.parse(r);
                  t.push(o.pageInfo);
                }
              } catch (n) {
                a(
                  'There was an error retrieving page information for all pages from core. Reverting to individual queries.'
                );
                for (let n = 0; n < e; n++)
                  try {
                    const e = Te('page_info', { query: 'page_info', page: n });
                    r(
                      1 === e.length,
                      'expected page_info result to return 1 result when specifying index.'
                    );
                    const o = new TextDecoder().decode(e[0]),
                      i = JSON.parse(o);
                    t.push(i.pageInfo);
                  } catch (e) {
                    a(
                      `Dimensional information for page ${n} unavailable, page will not be displayed.`
                    );
                    const r = {
                      height: 0,
                      matrix: [0, 0, 0, 0, 0, 0],
            ...
            async runPDFFormattingScripts(e, t) {
              ...
              r(
                fe,
                'PDF Formatting Scripts can only run after JavaScript is enabled.'
              );
              try {
                n = Te('run_pdf_formatting_scripts', {
                  form_fqns: e,
                  only_if_no_ap_stream: t,
                });
              } catch (e) {
                throw new Error(
                  'An error occurred while executing the document level JavaScript formatting.\n\n' +
                    e.message
                );
              }
              return n[0].changes || [];
            ...
            async getBookmarks() {
              const e = Te('get_bookmarks');
              return (
                r(
                  1 === e.length,
                  'expected only one response for getBookmarks'
                ),
                e[0].bookmarks || []
              );
            }
            async getFormJSON() {
              return De('getFormJSON').formJSON;
            }
            async getFormValues() {
              return De('getFormValues').formValues;
            }
                  ...
                  return o
                    ? o.value === t.value ||
                      (Array.isArray(o.value) &&
                        ...
                        o.value.every((e, n) => e === t.value[n]))
                      ? t
                      : ('string' == typeof o.value && o.value.length > 0
                          ? r.push({ widgets: t.widgets, text: o.value })
                          : t.widgets.forEach((e) => {
                              'number' == typeof e.pdfObjectId &&
                ...
                if (we)
                  for (let e = 0; e < r.length; e++) {
                    ...
                    for (let n = 0; n < t.length; n++)
                      await this.preflightWidgetAnnotation(
                        t[n],
                        t[n].pdfObjectId,
                        r[e].text
                      );
            ...
            async applyComments(e) {
              try {
                return Te('apply_comments', { comments: e });
              } catch (e) {
                throw new Error(`Error applying comments: ${e.message}`);
              }
            }
            async prepareSign(e, t, n, o, i, a) {
              let s;
              try {
                s = Te('get_signatures', {
                  certificate_check_time: 'current_time',
              ...
              try {
                c = Te('prepare_sign', {
                  ...
                  signature_metadata: {
                    ...t,
                    type: 'pspdfkit/signature-metadata',
                  },
                });
              } catch (e) {
              ...
              return (
                (e && e?.signatureType !== Z) ||
                  (l = de.FS.readFile(c[0].result.file_contents).buffer),
                de.FS.unlink(c[0].result.file_contents),
                {
            ...
            async getTimestampRequest(e, t) {
              try {
                const [n] = Te('get_timestamp_http_request', {
                ...
                throw new Error(
                  `Error getting timestamp request: ${e.message}`
                );
              }
            }
            async getRevocationRequests(e) {
              try {
                return Te('get_revocation_http_requests', {
                  signing_certificates: e,
                });
              } catch (e) {
                throw new Error(
                  `Error getting revocations requests: ${e.message}`
                );
              }
            }
            async setSignaturesLTV(e) {
              try {
                const t = Te('get_signatures', {
                  certificate_check_time: 'current_time',
                  ...
                  p = a
                    ...
                    : (function (e) {
                        try {
                          ...
                          return !!t.length && 48 === t[0];
                        } catch (e) {
                          throw new Error(
                            `Error checking if the signature is in PKCS#7 format: ${e.message}`
                          );
                        }
                      })(d);
                p ||
            ...
            async evalFormValuesActions(e) {
              const t = We().reduce(
                (t, n) =>
                  e.find((e) => {
                    let { name: t } = e;
                    return n.formField.name === t;
                  }) && 'pspdfkit/form-field/text' === n.formField.type
                    ? t.concat(n)
                    : t,
                []
              );
                ...
                for (let n = 0; n < t.length; n++) {
                  ...
                  for (let n = 0; n < r.length; n++)
                    await this.preflightWidgetAnnotation(
                      r[n],
                      r[n].pdfObjectId,
                      e.find((e) => t[n].formField.name === e.name)?.value
                    );
                }
              const n = Te('set_form_values_get_script_changes', {
                form_values: e,
              });
              return (
                r(
                  1 === n.length,
                  'expected only one response for evalFormValuesActions'
                ),
                this._processChanges(n[0].changes)
              );
            }
            ...
            _processChanges(e) {
              return e.map((e) =>
                'pspdfkit/javascript/effects/importIcon' === e.object.type
                  ? {
                      ...e,
                      object: {
                        ...e.object,
                        id: Object.entries(this._pdfObjectIdsForIds).find(
                          (t) => {
                            let [, n] = t;
                            return n === e.object.annotationID;
                          }
                        )?.[0],
                      },
                    }
            ...
            async evalScript(e, t, n) {
              const o = Te('run_pdf_javascript', {
                pdf_javascript_contents: e,
                pdf_javascript_trigger_event: t,
                pdf_javascript_form_fqn: n,
              });
              return (
                r(1 === o.length, 'expected only one response for evalScript'),
                this._processChanges(o[0].changes)
              );
            }
            async closeDocument() {
              try {
                return (
                  (he = []),
                  (ye = { password: void 0, initialPageIndex: void 0 }),
                  (fe = !1),
                  (Re = null),
                  (Le = !1),
                  (Je = !1),
            ...
            async renderAnnotation(e, t, n, r, o, i) {
              return qe(
                { ...e, pdfObjectId: this._getPdfObjectIdForObject(e) },
                t && (await M(t)),
                n,
                r,
                o,
            ...
            async renderPageAnnotations(e, t, n, r, o) {
              return t.map((t, i) =>
                qe(
                  { pdfObjectId: t, pageIndex: e },
                  0,
                  n[i],
                  r[i],
                  Ge(o, { width: n[i], height: r[i] })
                )
              );
            }
            async renderDetachedAnnotation(e, t, n, o, i) {
              ...
              const a = t ? await M(t) : null,
                s = t ? t.type : null;
              let c, l;
              const u = new de.VectorUint8();
              try {
                if (null != a)
                  for (let e = 0; e < a.byteLength; e++) u.push_back(a[e]);
                if (
                  ((l = Pe(
                  ...
                  l.hasError() || 1 !== l.getRepliesCount())
                ) {
                  const e = l.getErrorMessage(),
                    t = l.getErrorReason();
                  throw new Error(t + ': ' + e);
                }
            ...
            async loadCertificates(e) {
              if (Te('load_certificates', { certificates: e }).length > 0)
                throw new t('Internal error while loading certificates');
            }
            async getAttachment(e) {
              let t, n, r;
              const o = (await this.getEmbeddedFilesList())?.map((e) => e.id),
                i = o?.includes(e);
              try {
                if (i)
                  ...
                  if (
                    ...
                    n.hasError() || 1 !== n.getRepliesCount())
                  ) {
                    const e = n.getErrorMessage(),
                      t = n.getErrorReason();
                    throw new Error(
            ...
            async annotationsForPageIndex(e) {
              const t = De('annotationsForPageIndex', e);
              return (
                ['rollover', 'down'].forEach((e) => {
                  t.apstream_variants?.[e]?.forEach((n) => {
                    const r = t.annotations.find((e) => e.pdfObjectId === n);
                    r
                      ? (r[e] = !0)
                      : t.annotations.push({ pdfObjectId: n, [e]: !0 });
                  });
                }),
                t.annotations
              );
            ...
            async getTabOrder(e) {
              return Te('get_annotation_tab_order', { page: e })[0].order.map(
                (e) => ({
                  id:
                    Object.entries(this._pdfObjectIdsForIds).find((t) => {
                      let [n, r] = t;
                      return r === e;
                    })?.[0] || String(e),
                  pdfObjectId: e,
            ...
            async setTabOrder(e, t) {
              Te('set_annotation_tab_order', {
                page: e,
                order: t.map((e) => this._getPdfObjectIdForObject(e)),
              });
            }
            async createAnnotation(e, t) {
              ...
              const n = e.pdfObjectId,
                o = t ? await M(t) : null;
              let i;
              const a = new de.VectorUint8();
              try {
                if (null != o)
                  for (let e = 0; e < o.byteLength; e++) a.push_back(o[e]);
                'pspdfkit/widget' === e.type && (ze(!1), Ue());
                const t =
                  ('pspdfkit/shape/ellipse' === e.type ||
                    'pspdfkit/shape/rectangle' === e.type) &&
                  e.measurementScale
                    ? { ...e, measurementBBox: e.bbox }
                    : e;
                i = De(
                  'createAnnotation',
                  JSON.stringify({ ...t, pdfObjectId: null }),
                  a
                );
              } finally {
                a && a.delete();
              ...
              return (
                'number' == typeof n &&
                  'number' == typeof this._pdfObjectIdsForIds[n.toString()] &&
                  delete this._pdfObjectIdsForIds[n.toString()],
                (this._pdfObjectIdsForIds[e.id || i.pdfObjectId.toString()] =
                  i.pdfObjectId),
                e &&
                  this.canPreflightAnnotation(e) &&
                  we &&
                  (await this.preflightAnnotation(e, i.pdfObjectId)),
                i.pdfObjectId
              );
            }
            async updateAnnotation(e) {
              const t = { ...e, pdfObjectId: this._getPdfObjectIdForObject(e) };
              if (
                (r(t.id, 'Annotation must have an ID'),
                r(
                  'number' == typeof t.pageIndex,
                  'Annotation must have a pageIndex'
                ),
                'pspdfkit/widget' === t.type)
              ) {
                const e = We(),
                  n =
                ...
                Ve(
                  e.map((e) =>
                    e.formField.annotationIds.includes(n) ||
                    e.formField.annotationIds.includes(String(t.pdfObjectId))
                      ? {
                          ...e,
                          widgets: e.widgets.map((e) =>
                            e.id === n || String(e.pdfObjectId) === n ? t : e
                          ),
                        }
                      : e
                  )
            ...
            async deleteAnnotation(e) {
              if (
                (e.APStreamCache && (await this.updateAnnotation(e)),
                'pspdfkit/widget' === e.type)
              )
                try {
                  const t = e.id;
                  Ve(
                    We()
                      .map((n) => {
                        if (
                          n.formField.annotationIds.includes(t) ||
                          n.formField.annotationIds.includes(
                          ...
                          if (
                            ('pspdfkit/form-field/checkbox' ===
                              ...
                              'pspdfkit/form-field/radio' ===
                                n.formField.type) &&
                            n.formField.options.length ===
                              n.formField.annotationIds.length
                          ) {
                            const i = n.formField.annotationIds.includes(t)
                              ? n.formField.annotationIds.indexOf(t)
                ...
                try {
                  Te('remove_annotations', {
                    annotation_ids: [this._getPdfObjectIdForObject(e)],
                  });
                } catch (t) {
                  i(
            ...
            async createFormField(e, t) {
              ...
              if (!i)
                throw new Error(
                  `Error creating new form field in /create.pdf: created form field not found. ${JSON.stringify({ type: 'pspdfkit/form-field-with-widgets', formField: e, widgets: t })}`
                );
              const a = i.widgets.map(
                (e) => (
                  (this._pdfObjectIdsForIds[e.id] = e.pdfObjectId),
                  e.pdfObjectId
                )
              );
              return (
                'number' == typeof e.pdfObjectId &&
                  'number' ==
                    typeof this._pdfObjectIdsForIds[e.pdfObjectId.toString()] &&
                  delete this._pdfObjectIdsForIds[e.pdfObjectId.toString()],
                (this._pdfObjectIdsForIds[
                  e.id || i.formField.pdfObjectId.toString()
                ] = i.formField.pdfObjectId),
                a
              );
            }
            async updateFormField(e, t) {
              let n = {
                ...e,
                pdfObjectId:
                  this._pdfObjectIdsForIds[e.id] ||
                  this._getPdfObjectIdForObject(e),
              };
              const r = We(),
                o = r.find(
                  (t) => He(t.formField, n) || t.formField.name === e.name
                );
              if (!o)
                throw new Error(
                  `Error updating form field with name "${e.name}" in /create.pdf: form field not found. ${JSON.stringify(r)}`
                );
              const i = o.formField.name !== e.name;
              let a = null;
              if (i && 'pspdfkit/form-field/radio' === n.type) {
                const o = e.name,
                  i = r.find((e) => e.formField.name === o);
                i &&
                  'pspdfkit/form-field/radio' === i.formField.type &&
                  ((n = {
                    ...n,
                    annotationIds: [
                      ...n.annotationIds,
                      ...i.formField.annotationIds,
                    ],
                    options: [...n.options, ...i.formField.options],
                  }),
                  (t = [...t, ...i.widgets]),
                  (a = i));
              }
              Ve(
                r
                  .map((r) => {
                    if (
                      a &&
                      a.formField.pdfObjectId === r.formField.pdfObjectId
                    )
                      return null;
                    if (He(r.formField, n) || r.formField.name === e.name) {
                      const o = {
                        type: 'pspdfkit/form-field-with-widgets',
                        formField: { ...r.formField, ...n },
                        widgets: t.reduce(
                          (e, t) => [
                            ...e,
                            {
              ...
              const s = We().find((t) => t.formField.name === e.name);
              if (!s)
                throw new Error(
            ...
            async deleteFormField(e) {
              const t = We(),
                n = t.find((t) => t.formField.name === e.name);
              if (!n) return;
              Ve(t.filter((t) => t.formField.name !== e.name));
              const r = We().find((t) => t.formField.name === e.name);
              if (r)
                throw new Error(
                  `Error deleting form field with name "${e.name}" in /create.pdf: form field still present. ${JSON.stringify(r)}`
                );
              n.widgets.forEach((e) => {
                delete this._pdfObjectIdsForIds[e.id];
              });
            ...
            async preflightAnnotation(e, t) {
              ...
              const n = 'pspdfkit/stamp' === e.type ? e.title : e.text?.value;
              'number' != typeof t || n
                ? n &&
                  (await this.preflightRenderAnnotationText(n, t, e.pageIndex, {
                    ...e,
                    pdfObjectId: this._getPdfObjectIdForObject(e),
                    pageIndex: 0,
                  }))
            ...
            async preflightWidgetAnnotation(e, t, n) {
              n || 'number' != typeof t
                ? n &&
                  (await this.preflightRenderAnnotationText(n, t, e.pageIndex))
                : ve.delete(t);
            ...
            async createBookmark(e) {
              try {
                ...
                throw new Error(
                  `Error creating new bookmark in /create.pdf: ${e.message}`
                );
              }
            }
            ...
            async deleteBookmark(e) {
              try {
                Te('remove_bookmarks', { bookmarkIds: [e] });
              } catch (e) {
                throw new Error(
                  `Error deleting bookmark in /create.pdf: ${e.message}`
                );
              }
            }
            async getTextFromRects(e, t) {
              return De(
                'getTextFromRects',
                e,
                JSON.stringify(t.map((e) => [e.left, e.top, e.width, e.height]))
              ).text;
            }
            ...
            async parseXFDF(e, t) {
              try {
                return (function (e) {
                  ...
                  Te(
                    'convert_xfdf_to_instant_json',
                    { ignore_page_rotation: t },
                    e
                  )[0]
                );
              } catch (e) {
            ...
            async getEmbeddedFilesList() {
              return Te('list_embedded_files')[0].embeddedFiles || null;
            }
            async getMeasurementSnappingPoints(e) {
              const t = Te('get_snapping_points', { page: e });
              return t[0].snappingPoints
                ? (function (e) {
                    const t = [
                        ...e.endpoints,
                        ...e.intersections,
            ...
            async getSecondaryMeasurementUnit() {
              try {
                return Te('get_secondary_measurement_unit')[0] || null;
              } catch (e) {
                throw new Error(
                  `Error getting secondary measurement: ${e.message}`
                );
              }
            }
            async compareDocuments(e) {
              try {
                r(
                  ...
                  r(
                    e.changedDocument.arrayBuffer,
                    'Changed document arrayBuffer is missing'
                  ),
                  de.FS.writeFile(
                    'documentA.pdf',
                    new Uint8Array(e.originalDocument.arrayBuffer)
                  ),
                  de.FS.writeFile(
                    'documentB.pdf',
                ...
                const t = {
                  originalDocument: {
                    ...e.originalDocument,
                    filePath: 'documentA.pdf',
                  },
                  changedDocument: {
                    ...e.changedDocument,
                    filePath: 'documentB.pdf',
                  },
                  comparisons: [e.comparisonOperation],
                };
                return Te('document_comparison', t) || null;
              } catch (e) {
            ...
            async setSecondaryMeasurementUnit(e) {
              try {
                Te(
                  ...
                  e ? { unitTo: e?.unitTo, precision: e?.precision } : null
                );
              } catch (e) {
                i('Error setting secondary measurement unit');
              }
            }
            async getMeasurementScales() {
              try {
                return Te('get_measurement_content_formats')[0] || null;
              } catch (e) {
                throw new Error(
                  `Error getting measurement scales: ${e.message}`
                );
              }
            }
            async removeMeasurementScale(e) {
              try {
                Te('remove_measurement_content_format', {
                  measurementContentFormat: S(e),
                });
              } catch (t) {
                throw new Error(
                  `Error removing ${e.name} measurement scale: ${t.message}`
                );
              }
            }
            async addMeasurementScale(e) {
              try {
                Te('add_measurement_content_format', {
                  measurementContentFormat: S(e),
                });
              } catch (t) {
                throw new Error(
                  `Error adding ${e.name} measurement scale: ${t.message}`
                );
              }
            }
            async getAnnotationsByScale(e) {
              try {
                return (
                  Te('get_annotations_for_measurement_content_format', {
                    measurementContentFormat: S(e),
                  }) || null
                );
              } catch (e) {
            ...
            async exportFile(e, t, n, o, i, a, s, c) {
              let l,
              ...
              try {
                ...
                (l = Te('save_document', {
                  ...
                  c &&
                    (c.forEach((e) => {
                      let { pageIndex: t, id: n, pdfObjectId: r } = e;
                      Te('electronic_signatures/flatten', {
                        page: t,
                        annotation_id: this._getPdfObjectIdForObject({
                          id: n,
                          pdfObjectId: r,
                        }),
                      });
            ...
            async importInstantJSON(e) {
              De('importInstantDocumentJSON', JSON.stringify(e));
            }
            ...
            async getDocumentOutline() {
              ...
              return (
                r(
                  1 === e.length,
                  'expected only one response for getDocumentOutline'
                ),
                e[0].outline || []
              );
            }
            async setDocumentOutline(e) {
              return Te('set_outline', { outline: e });
            }
            async getPageGlyphs(e) {
              return Te('get_glyphs', { page: e })[0].glyphs || [];
            }
            async onKeystrokeEvent(e) {
              const t = Te('on_keystroke_event', { pdf_javascript_event: e });
              r(
                1 === t.length,
                'expected only one response for onKeystrokeEvent'
              );
              const n = t[0].changes || [];
              return (
                r(
                  n.length > 0 && 4 === n[0].change_type,
                  'expected onKeystrokeEvent to return at least one JavaScript Event change.'
                ),
                n
              );
            }
            async version() {
              return De('PSPDFKitVersion').version;
            }
            getImportedXFDF() {
              return he;
            }
            async applyRedactions() {
              try {
                De('saveDocument', se, !1, !1, !0, !1, 'pdf', !1);
              } catch (e) {
                throw new Error(
                  `Error applying redactions and saving to /create.pdf: ${e.message}`
                );
              }
            }
            async clearAPStreamCache() {
              De('clearAPStreamCache');
            }
            async setComparisonDocument(e, t) {
              this.comparisonDocuments[e] =
                t || (await this.exportFile(!1, !1, !1, 'pdf', !1, !1))[0];
            }
            async openComparisonDocument(e) {
              return (
                r(this.comparisonDocuments[e]),
                e === this.lastOpenedComparisonDocument ||
                (e === R &&
                  null === this.lastOpenedComparisonDocument &&
                  this.persistedOpenDocument instanceof ArrayBuffer)
                  ? null
                  : ((this.lastOpenedComparisonDocument = e),
                    this.openDocument(
                      this.comparisonDocuments[e],
                      this.persistedOpenDocument === e
                        ? this.persistedOpenDocumentConfiguration
                        : ge
                    ))
              );
            }
            async documentCompareAndOpen(e) {
              r(
                this.comparisonDocuments[R] && this.comparisonDocuments[L],
                'One or both comparison input documents are missing.'
              );
              const t = `${R}.pdf`,
                n = `${L}.pdf`;
              ...
              return (
                Te('comparison', {
                  ...
                  documentB: {
                    strokeColor: e.documentB.strokeColor,
                    pageIndex: e.documentB.pageIndex,
                    filePath: n,
                  },
                  options: { ...e.options, outputFilePath: 'output.pdf' },
                }),
                await this.closeDocument(),
                (this.comparisonDocuments[U] =
                  de.FS.readFile('output.pdf').buffer),
                (this.lastOpenedComparisonDocument = U),
                this.openDocument(this.comparisonDocuments[U], ge)
              );
            }
            async persistOpenDocument(e) {
              if (e) this.persistedOpenDocument = e;
              else
                try {
                  this.persistedOpenDocument = (
                    await this.exportFile(!1, !1, !1, 'pdf', !1, !0)
                  )[0];
                } catch (e) {
                  throw new Error(
                    `Error trying to persist a copy of the currently opened document: ${e.message}`
                  );
                }
              this.persistedOpenDocumentConfiguration = ye;
            }
            async cleanupDocumentComparison() {
              r(
                this.persistedOpenDocument,
                'No persisted previous document key or array buffer is available.'
              );
              const e =
                this.persistedOpenDocument instanceof ArrayBuffer
                  ? this.persistedOpenDocument
                  : this.comparisonDocuments[this.persistedOpenDocument];
              r(e, 'No persisted previous array buffer is available.');
              try {
                await this.closeDocument();
              } catch (e) {
                throw new Error(
                  `Error trying to close the current document: ${e.message}`
                );
              }
              const t = this.openDocument(
                e,
                this.persistedOpenDocumentConfiguration
              );
              return (
                (this.persistedOpenDocument = null),
                (this.persistedOpenDocumentConfiguration = ge),
                (this.lastOpenedComparisonDocument = null),
                (this.comparisonDocuments = {}),
                t
              );
            }
            ...
            async getOCGs() {
              return Te('ocg/get_ocgs')[0].ocgs;
            }
            async getOCGVisibilityState() {
              return {
                visibleLayerIds: Te('ocg/get_visibility_state')[0].state
                  .visible,
              };
            }
            async setOCGVisibilityState(e) {
              return Te('ocg/set_visibility_state', {
                state: { visible: e.visibleLayerIds },
              });
            }
            async dispatchCommand(e) {
              ...
              Se && (t = performance.now());
              try {
                if (((n = await de.dispatchCommand(e)), null === n))
                  throw Error('dispatchCommand returned null');
                if (n.hasError())
                  return {
                    success: !1,
                    message: n.getErrorMessage(),
                    code: n.getErrorReason(),
                  };
            ...
            openFile(e, t) {
              const n = de.FS.open(e, t);
              return (
                this.files.set(this.fileDescriptor, n),
                Promise.resolve(this.fileDescriptor++)
              );
            }
            closeFile(e) {
            ...
            writeData(e, t, n) {
              ...
              if (!r)
                throw Error(
                  `Trying to write to a file with descriptor ${e}, but the file is not open.`
                );
              return (
                de.FS.write(r, new Uint8Array(t), 0, t.byteLength, n),
                Promise.resolve()
              );
            }
            recycle() {}
        ...
        (Xe.global = Xe),
          ...
          (Xe.onmessage = async (e) => {
            let t,
              ...
              { data: r } = e;
            try {
              const e = await Ye[r.action](...r.args);
              if (((t = { id: r.id, result: e }), Array.isArray(e))) {
