  ...
  [5534],
  {
    15124: (e, t, s) => {
      ...
      var i = s(67136),
        ...
        r = s(82987),
        c = s(78236);
      class l extends n.mS({
        clientId: '',
        userId: null,
        presenceContent: {},
      }) {}
      class d extends n.mS({
        status: 'offline',
        currentClient: null,
        clients: (0, n.T5)(),
      }) {}
      ...
      class y {
        ...
        sendRequest(e, t) {
          return new Promise((s, i) => {
            ...
            const n = this.nextRequestId(),
              a = JSON.stringify(t);
            this.requestsWaitingForAnswers = this.requestsWaitingForAnswers.set(
              n,
              { resolve: s, reject: i }
            );
            this.socket.send(`${n}:${e}:${a}`);
          });
        }
        on(e, t) {
        ...
        onMessage(e) {
          ...
          if (this.isAuthenticated) {
            ...
            if (e.requestId) {
              ...
              switch (((0, p.V)(s), e.action)) {
                case 'ok':
                  s.resolve(e.payload);
                  break;
                case 'error':
                  s.reject(new o.uE(e.payload.reason || 'Unknown error'));
                  break;
                default:
                  (0, p.V)(!1, `${e.action} is not a valid request reply`);
              }
            ...
            switch (e.action) {
              ...
              case 'error':
                this.eventEmitter.emit(
                  'error',
                  e.payload.reason || 'Unknown error'
                );
            }
          }
        }
        ...
        parseFrame(e) {
          const [, t, s, i] = /^(\d+|info):([a-zA-Z-_]+):(.+)$/.exec(
            e.toString()
          );
          let n = null;
          'info' !== t && (n = parseInt(t));
        ...
        parseUnauthenticatedFrame(e) {
          const [, t, s] = /^(hello|authenticated|error):(.+)$/.exec(
            e.toString()
          );
                ...
                (this.setState(
                  (function (e, t) {
                    return (
                      ...
                      e.withMutations((s) => {
                        const i = (0, n.T5)(
                          t.clients.map((e) => F(e)).map((e) => [e.clientId, e])
                        ).set(e.currentClient?.clientId, e.currentClient);
                        s.set('clients', i);
                      })
                    );
                  })(this.state, e)
        ...
        onInfoClientPresence(e) {
          if (
            ...
            if (e.clients.entered) {
              ...
              t = this.state.clients
                .filter((e) => -1 !== s.indexOf(e.clientId))
                .toMap();
            }
            let s = (0, n.T5)();
            if (e.clients.updated) {
              const t = e.clients.updated.map((e) => e.client_id);
              s = this.state.clients
                .filter((e) => -1 !== t.indexOf(e.clientId))
                .toMap();
            }
            let i = (0, n.B8)();
        ...
        updatePresence(e) {
          return new Promise((t, s) => {
            if ('online' !== this.getStatus())
              return s(new o.uE('ClientsPresence is not connected'));
            this.connection
      ...
      var R = s(33728);
      class A extends n.mS({
        requestInfo: null,
        status: 'offline',
        currentClient: null,
        localRecordsContents: (0, n.uY)(),
        localRecordsChanges: (0, n.B8)(),
        stagedRecordsChanges: (0, n.B8)(),
        localRecordsRev: 0,
        requiredAttachmentIds: (0, n.NZ)(),
        clients: (0, n.T5)(),
      }) {}
      var V = s(84192);
      class x {
        ...
        updateRecord(e, t, s, i) {
          return new Promise((n, a) => {
            if (!this.isKnownRecordId(e))
              return a(new o.uE(`Record with ID: ${e} not found.`));
            const r = new v({
              id: e,
              content: t,
              group: s,
        ...
        deleteRecord(e) {
          return new Promise((t, s) => {
            if (!this.isKnownRecordId(e))
              return s(new o.uE(`Record with ID: ${e} not found.`));
            const i = new v({ id: e, type: 'deleted', resolve: t, reject: s });
        ...
        constructor() {
          ...
          ((0, i.A)(this, '_recordsUpdatesCallback', () => {}),
            ...
            (0, i.A)(this, 'onAcceptedRecords', (e) => {
              if (this._shouldFireRecordsUpdateCallback) {
                const { created: t, updated: s, deleted: i } = e;
            ...
            (0, i.A)(this, 'setOnDocumentHandleConflictCallback', (e) => {
              if ('function' != typeof e)
                throw new TypeError('callback must be a function');
      ...
      class W {
        constructor(e, t, s) {
          ...
          ((0, i.A)(this, '_existingBookmarksIds', (0, n.NZ)()),
            ...
            (0, i.A)(this, '_documentHandleConflictCallback', () => {}),
            (0, i.A)(this, 'canCreateBackendOrphanWidgets', !0),
            (0, i.A)(this, 'setDocumentHandleConflictCallback', (e) => {
              this._documentHandleConflictCallback = e;
            }),
            (0, i.A)(this, 'setDocumentHandleOutdated', (e) => {
        ...
        createAnnotation(e, t) {
          const { id: s, ...i } = (0, a.eq)(e),
            { group: n, permissions: r, ...c } = i;
          return (
            (0, o.V1)(s, 'Annotation id must be defined.'),
            this._sync.createRecord(s, c, (0, a.L)(t), n)
          );
        }
        createComment(e) {
          const { id: t, ...s } = (0, D.z)(e, e.rootId),
            { group: i, permissions: n, isAnonymous: a, ...r } = s;
          return (
            (0, o.V1)(t, 'Comment id must be defined.'),
            (this._existingCommentIds = this._existingCommentIds.add(t)),
            this._sync.createRecord(t, r, {}, i, !!a)
          );
        }
        async updateComment(e) {
          try {
            await this.updateRecord((0, D.z)(e, e.rootId));
          } catch (e) {
            if (!(e instanceof o.uE)) throw e;
          }
        }
        deleteComment(e) {
          return (
        ...
        async updateRecord(e) {
          const {
            ...
            group: n,
            ...a
          } = 'pspdfkit/comment' === e.type ||
          'pspdfkit/comment-marker' === e.type
            ? e
            : { ...e, isAnonymous: void 0 };
          return (
            (0, o.V1)(t, 'Record id must be defined.'),
            this._getState?.()?.backend?.isCollaborationPermissionsEnabled()
              ? ((0, o.V1)(s, 'Permissions must be defined.'),
                this._sync.updateRecord(
                  t,
                  s.edit ? a : void 0,
                  s.setGroup ? (n ?? void 0) : void 0,
                  i ?? void 0
                ))
              : this._sync.updateRecord(t, a, n ?? void 0, i ?? void 0)
          );
        }
        async updateAnnotation(e) {
          try {
            await this.updateRecord((0, a.eq)(e));
          } catch (e) {
            if (!(e instanceof o.uE)) throw e;
          }
        }
        ...
        createBookmark(e) {
          const { id: t, ...s } = (0, r.U)(e);
          return (
            (this._existingBookmarksIds = this._existingBookmarksIds.add(t)),
            this._sync.createRecord(t, s, {})
          );
        }
        ...
        createFormField(e) {
          const { group: t, permissions: s, id: i, ...n } = (0, a.T7)(e);
          return (
            (this._existingFormFieldsIds = this._existingFormFieldsIds.add(i)),
            this._sync.createRecord(i, n, {}, t)
          );
        }
        async updateFormField(e) {
          try {
            await this.updateRecord((0, a.T7)(e));
          } catch (e) {
            if (!(e instanceof o.uE)) throw e;
          }
        }
        deleteFormField(e) {
          return this._sync.deleteRecord(e.id).then(() => {
            this._existingFormFieldsIds = this._existingFormFieldsIds.delete(
              e.id
            );
          });
        }
        ...
        createFormFieldValue(e) {
          ...
          return (
            (this._existingFormFieldValuesIds =
              this._existingFormFieldValuesIds.add(s)),
        ...
        async setFormFieldValue(e) {
          const t = (0, a.cA)(e);
          try {
            await this._sync.updateRecord((0, E.B)(e), t);
          } catch (e) {
            if (!(e instanceof o.uE)) throw e;
          }
        }
                ...
                () => {
                  this._hasLoadedInitialRecords ||
                    (this._sync.onRecordsUpdates(
                      (e, t, s) => this._onRecordsUpdates(e, t, s, c.N),
                      (e, t, s) => this._onAcceptedRecords(e, t, s)
                    ),
                    this._onRecordsUpdates(
                      this._sync.getRecords(),
                      (0, n.B8)(),
                      (0, n.B8)(),
                      c.n
                    ),
        ...
        _filterRecords(e) {
          return e.filter((e) => {
            let { content: t } = e;
            return this._formsEnabledInConfig || !(0, a.cy)(t);
          });
        }
        _onRecordsUpdates(e, t, s, i) {
          ...
          let d = (0, n.B8)(),
            ...
            _ = (0, n.NZ)(),
            f = (0, n.NZ)();
          const C = this._getState ? this._getState() : void 0;
          let k = e,
            g = t,
            b = s;
          if (C && C.backend && C.backend.isCollaborationPermissionsEnabled()) {
            k = k.filter((e) => {
              let { content: t } = e;
              return !!t;
            });
          ...
          let y = (0, n.B8)().withMutations((e) => {
            this._filterRecords(k).forEach((t) => {
              ...
              const p = { permissions: n, group: u, isAnonymous: m };
              try {
                (0, a.cy)(i)
                  ? (l.push((0, a.mh)(s, i, p)),
                    (this._existingFormFieldsIds =
                      this._existingFormFieldsIds.add(s)))
                  : (0, a.UR)(i)
                    ? ((d = d.push((0, a.R5)(i))),
                      (this._existingFormFieldValuesIds =
                        this._existingFormFieldValuesIds.add(s)))
                    : (0, a.fW)(i)
                      ? ((c = c.push((0, r.r)(s, i))),
                        (this._existingBookmarksIds =
                          this._existingBookmarksIds.add(s)))
                      : (0, a.Eh)(i)
                        ? ((this._existingCommentIds =
                            this._existingCommentIds.add(s)),
                          (h = h.push((0, D._)(s, i, p))))
                        : (0, a.Tg)(i) ||
                          (0, a.LK)(i) ||
                          e.push((0, a.h8)(s, i, p));
              } catch (e) {
          ...
          (l.length > 0 &&
            ...
            C && !F
              ? this._formFieldCallbacks.createFormFields(
                  (0, n.B8)(l.filter((e) => !(e instanceof N.Vw))),
                  i
                )
              : this._formFieldCallbacks.createFormFields((0, n.B8)(l), i)),
            y.size > 0 &&
              ...
              C &&
                ...
                (y = y.filter((e) => {
                  ...
                  const t =
                    l.find((t) => t.name === e.formFieldName) ||
                    C.formFields.get(e.formFieldName);
                  return !(t && t instanceof N.Vw);
                })),
              this._annotationCallbacks.createAnnotations(y, (0, n.T5)(), i)),
            d.size > 0 &&
          ...
          const w = (0, n.B8)().asMutable(),
            ...
            A = (0, n.B8)().withMutations((e) => {
              this._filterRecords(g).forEach((t) => {
                ...
                const d = { permissions: c, group: n, isAnonymous: l };
                try {
                  if ((0, a.cy)(i))
                    try {
                      I.push((0, a.mh)(s, i, d));
          ...
          (A.size > 0 &&
            ...
            w.size > 0 &&
              ((0, o.V1)(this._bookmarkCallbacks),
              this._bookmarkCallbacks.updateBookmarks(w)),
            I.length > 0 &&
              ((0, o.V1)(this._formFieldCallbacks),
              this._formFieldCallbacks.updateFormFields((0, n.B8)(I))),
            v.length > 0 &&
              ((0, o.V1)(this._formFieldValueCallbacks),
              this._formFieldValueCallbacks.setFormFieldValues((0, n.B8)(v))),
            R.length > 0 &&
              ((0, o.V1)(this._commentCallbacks),
              this._commentCallbacks.updateComments((0, n.B8)(R))),
            (u = u.concat(
              b
                .filter(
                  (e) =>
              ...
              b
                .filter((e) => {
                  ...
                  return (
                    t &&
                      (this._existingBookmarksIds =
                        this._existingBookmarksIds.delete(e)),
                    t
                  );
                })
                .toSet()
            ...
            m.size > 0 &&
              ((0, o.V1)(this._bookmarkCallbacks),
              this._bookmarkCallbacks.deleteBookmarks(m)),
            (p = p.concat(
              b
                .filter((e) => {
                  ...
                  return (
                    t &&
                      (this._existingFormFieldsIds =
                        this._existingFormFieldsIds.delete(e)),
                    t
                  );
                })
                .toSet()
            ...
            p.size > 0 &&
              ((0, o.V1)(this._formFieldCallbacks),
              this._formFieldCallbacks.deleteFormFields(p)),
            (_ = _.concat(
              b
                .filter((e) => {
            ...
            _.size > 0 &&
              ((0, o.V1)(this._formFieldValueCallbacks),
              this._formFieldValueCallbacks.deleteFormFieldValues(_)),
            (f = f.concat(
              b
                .filter((e) => {
                  ...
                  return (
                    t &&
                      (this._existingCommentIds =
                        this._existingCommentIds.delete(e)),
                    t
                  );
                })
                .toSet()
        ...
        _onAcceptedRecords(e, t) {
          ...
          if (
            !s ||
            !s.backend ||
            !s.backend.isCollaborationPermissionsEnabled()
          )
            return;
          const i = [],
            a = [],
          ...
          (e.isEmpty() || e.forEach(h),
            ...
            i.length > 0 &&
              ((0, o.V1)(this._annotationCallbacks),
              this._annotationCallbacks.updateAnnotations((0, n.B8)(i), !0)),
            a.length > 0 &&
              ((0, o.V1)(this._commentCallbacks),
              this._commentCallbacks.updateComments((0, n.B8)(a))),
            r.length > 0 &&
              ((0, o.V1)(this._formFieldCallbacks),
              this._formFieldCallbacks.updateFormFields((0, n.B8)(r))),
            c.length > 0 &&
              ((0, o.V1)(this._annotationCallbacks),
              this._annotationCallbacks.deleteAnnotations((0, n.NZ)(c), !0)),
            l.length > 0 &&
              ((0, o.V1)(this._commentCallbacks),
        ...
        async updateTabOrder() {
          throw new o.uE('setTabOrder is not supported on this backend.');
        }
        async setTabOrder() {
          throw new o.uE('setTabOrder is not supported on this backend.');
        }
