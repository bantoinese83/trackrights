    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(139, 92, 246) 90deg, transparent 180deg)`,
        ...
        <motion.div
          className="absolute inset-0 rounded-full"
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(139, 92, 246) 120deg, rgba(167, 139, 250, 0.7) 240deg, transparent 360deg)`,
        ...
        <motion.div
          className="absolute inset-0 rounded-full"
          style={{
            background: `conic-gradient(from 180deg, transparent 0deg, rgba(124, 58, 237, 0.8) 45deg, transparent 90deg)`,
        ...
        <motion.div
          className="absolute inset-0 rounded-full"
          style={{
            background: `conic-gradient(from 270deg, transparent 0deg, rgba(167, 139, 250, 0.6) 20deg, transparent 40deg)`,
        ...
        <motion.div
          ...
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(167, 139, 250) 90deg, transparent 180deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 35%, black 37%, black 39%, transparent 41%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 35%, black 37%, black 39%, transparent 41%)`,
            opacity: 0.9,
          }}
        ...
        <motion.div
          className="absolute inset-0 rounded-full dark:block hidden"
          style={{
            background: `conic-gradient(from 0deg, transparent 0deg, rgb(167, 139, 250) 120deg, rgba(196, 181, 253, 0.7) 240deg, transparent 360deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 42%, black 44%, black 48%, transparent 50%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 42%, black 44%, black 48%, transparent 50%)`,
            opacity: 1,
          }}
        ...
        <motion.div
          className="absolute inset-0 rounded-full dark:block hidden"
          style={{
            background: `conic-gradient(from 180deg, transparent 0deg, rgba(196, 181, 253, 0.8) 45deg, transparent 90deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 52%, black 54%, black 56%, transparent 58%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 52%, black 54%, black 56%, transparent 58%)`,
            opacity: 0.6,
          }}
        ...
        <motion.div
          className="absolute inset-0 rounded-full dark:block hidden"
          style={{
            background: `conic-gradient(from 270deg, transparent 0deg, rgba(196, 181, 253, 0.6) 20deg, transparent 40deg)`,
            mask: `radial-gradient(circle at 50% 50%, transparent 61%, black 62%, black 63%, transparent 64%)`,
            WebkitMask: `radial-gradient(circle at 50% 50%, transparent 61%, black 62%, black 63%, transparent 64%)`,
            opacity: 0.7,
          }}
      ...
      >
        ...
        <motion.h1
          className={cn(
            config.titleClass,
            'text-purple-800 dark:text-purple-200 font-medium tracking-[-0.02em] leading-[1.15] antialiased'
          )}
          initial={{ opacity: 0, y: 12 }}
          animate={{
            opacity: 1,
        ...
        <motion.p
          className={cn(
            ...
            'text-purple-600 dark:text-purple-300 font-normal tracking-[-0.01em] leading-[1.45] antialiased'
          )}
