...
const contractForms: ContractForms = {
  ...
  bsa: {
    ...
    fields: {
      ...
      platforms: {
        label: 'Platforms (Twitch, YouTube, TikTok, Instagram, etc.)',
        type: 'textarea',
      },
  ...
  'ppa-twitch': {
    ...
    fields: {
      ...
      minimumStreamingHours: {
        label: 'Minimum Streaming Hours per Month',
        type: 'number',
      },
      subscriberBenefits: {
        label: 'Subscriber Benefits Required',
        type: 'textarea',
      },
  ...
  'ppa-youtube': {
    ...
    fields: {
      ...
      partnershipStartDate: { label: 'Partnership Start Date', type: 'date' },
      monetizationMethod: {
        label: 'Monetization Method (Ads, Memberships, etc.)',
        type: 'textarea',
      },
      revenueSharePercentage: {
        label: 'Revenue Share Percentage (%)',
  ...
  'ppa-tiktok': {
    ...
    fields: {
      ...
      minimumViews: {
        label: 'Minimum Views Required (per month)',
        type: 'number',
      },
  ...
  imc: {
    ...
    fields: {
      ...
      servicesProvided: {
        label: 'Services Provided by Manager',
        type: 'textarea',
      },
      exclusivityTerms: { label: 'Exclusivity Terms', type: 'textarea' },
      territory: { label: 'Territory', type: 'text' },
