...
var PSPDFModuleInit = (() => {
  ...
  return (
    'undefined' != typeof __filename && (e ||= __filename),
    function (r = {}) {
      var t,
        n,
        o,
      ...
      if (d) {
        ...
        ((p = __dirname + '/'),
          ...
          (o = (e, r = !0) => (
            (e = q(e) ? new URL(e) : v.normalize(e)),
            new Promise((t, n) => {
              m.readFile(e, r ? void 0 : 'utf8', (e, o) => {
      ...
      var I,
        ...
        q = (e) => e.startsWith('file://');
      function Y() {
        var e,
          r = 'pspdfkit.wasm.wasm';
        return V(r) ? r : ((e = r), i.locateFile ? i.locateFile(e, p) : p + e);
      }
      function G(e) {
        if (e == I && y) return new Uint8Array(y);
        if (a) return a(e);
      ...
      var Z = (e) => {
        ...
        ee = {
          ...
          basename: (e) => {
            if ('/' === e) return '/';
            var r = (e = (e = ee.normalize(e)).replace(/\/$/, '')).lastIndexOf(
              '/'
            );
            return -1 === r ? e : e.substr(r + 1);
          },
          join: (...e) => ee.normalize(e.join('/')),
          join2: (e, r) => ee.normalize(e + '/' + r),
        },
        re = (e) =>
          (re = (() => {
            if (
        ...
        ne = 'undefined' != typeof TextDecoder ? new TextDecoder() : void 0,
        oe = (e, r, t) => {
      ...
      var ue = {
          ...
          stream_ops: {
            ...
            read(e, r, t, n, o) {
              if (!e.tty || !e.tty.ops.get_char) throw new ye.ErrnoError(60);
        ...
        ce = {
          ops_table: null,
          mount: (e) => ce.createNode(null, '/', 16895, 0),
          createNode(e, r, t, n) {
            if (ye.isBlkdev(t) || ye.isFIFO(t)) throw new ye.ErrnoError(63);
            ce.ops_table ||= {
              dir: {
                node: {
              ...
              chrdev: {
                ...
                stream: ye.chrdev_stream_ops,
              },
            };
            var o = ye.createNode(e, r, t, n);
            return (
              ye.isDir(o.mode)
          ...
          node_ops: {
            getattr(e) {
              var r = {};
              return (
                (r.dev = ye.isChrdev(e.mode) ? e.id : 1),
                (r.ino = e.id),
                (r.mode = e.mode),
                (r.nlink = 1),
                (r.uid = 0),
            ...
            mknod: (e, r, t, n) => ce.createNode(e, r, t, n),
            rename(e, r, t) {
              if (ye.isDir(e.mode)) {
                var n;
                try {
          ...
          stream_ops: {
            ...
            write(e, r, t, n, o, a) {
              if ((r.buffer === _.buffer && (a = !1), !n)) return 0;
              var i = e.node;
              if (
            ...
            llseek(e, r, t) {
              ...
              if (
                (1 === t
                  ? (n += e.position)
                  : 2 === t &&
                    ye.isFile(e.node.mode) &&
                    (n += e.node.usedBytes),
                n < 0)
              )
                throw new ye.ErrnoError(28);
              return n;
            },
            allocate(e, r, t) {
        ...
        fe = (e, r, t, n, o, a) => {
          ye.createDataFile(e, r, t, n, o, a);
        },
        he = i.preloadPlugins || [],
        pe = (e, r, t, n, a, i, s, l, u, d) => {
        ...
        ve = {
          ...
          mount(e) {
            ...
            return (
              ...
              (e.opts.blobs || []).forEach(function (e) {
                ve.createNode(n(e.name), o(e.name), ve.FILE_MODE, 0, e.data);
              }),
          ...
          createNode(e, r, t, n, o, a) {
            var i = ye.createNode(e, r, t);
            return (
              (i.mode = t),
              (i.node_ops = ve.node_ops),
              (i.stream_ops = ve.stream_ops),
              (i.timestamp = (a || new Date()).getTime()),
              S(ve.FILE_MODE !== ve.DIR_MODE),
              t === ve.FILE_MODE
          ...
          stream_ops: {
            ...
            llseek(e, r, t) {
              ...
              if (
                (1 === t
                  ? (n += e.position)
                  : 2 === t && ye.isFile(e.node.mode) && (n += e.node.size),
                n < 0)
              )
                throw new ye.ErrnoError(28);
              return n;
        ...
        ye = {
          ...
          FSNode: class {
            ...
            get isFolder() {
              return ye.isDir(this.mode);
            }
            get isDevice() {
              return ye.isChrdev(this.mode);
            }
          },
          lookupPath(e, r = {}) {
            if (!(e = te.resolve(e))) return { path: '', node: null };
            if (
              (r = Object.assign({ follow_mount: !0, recurse_count: 0 }, r))
                .recurse_count > 8
            )
              throw new ye.ErrnoError(32);
            for (
              ...
              if (
                ...
                for (var s = 0; ye.isLink(n.mode); ) {
                  var l = ye.readlink(o);
                  if (
                    ((o = te.resolve(ee.dirname(o), l)),
                    (n = ye.lookupPath(o, {
          ...
          hashName(e, r) {
            ...
            return ((e + t) >>> 0) % ye.nameTable.length;
          },
          hashAddNode(e) {
          ...
          hashRemoveNode(e) {
            var r = ye.hashName(e.parent.id, e.name);
            if (ye.nameTable[r] === e) ye.nameTable[r] = e.name_next;
            else
              for (var t = ye.nameTable[r]; t; ) {
                if (t.name_next === e) {
          ...
          lookupNode(e, r) {
            var t = ye.mayLookup(e);
            if (t) throw new ye.ErrnoError(t);
            for (
              var n = ye.hashName(e.id, r), o = ye.nameTable[n];
              o;
              o = o.name_next
            ) {
              var a = o.name;
          ...
          nodePermissions: (e, r) =>
            ...
            ((!r.includes('r') || 292 & e.mode) &&
              ...
              : 2,
          mayLookup(e) {
            if (!ye.isDir(e.mode)) return 54;
            var r = ye.nodePermissions(e, 'x');
          ...
          mayCreate(e, r) {
            ...
            return ye.nodePermissions(e, 'wx');
          },
          mayDelete(e, r, t) {
            var n;
            try {
            ...
            var o = ye.nodePermissions(e, 'wx');
            if (o) return o;
            if (t) {
              if (!ye.isDir(n.mode)) return 54;
              if (ye.isRoot(n) || ye.getPath(n) === ye.cwd()) return 10;
            } else if (ye.isDir(n.mode)) return 31;
            return 0;
          },
          mayOpen: (e, r) =>
            e
              ? ye.isLink(e.mode)
                ? 32
                : ye.isDir(e.mode) &&
                    ('r' !== ye.flagsToPermissionString(r) || 512 & r)
                  ? 31
                  : ye.nodePermissions(e, ye.flagsToPermissionString(r))
              : 44,
          MAX_OPEN_FDS: 4096,
          nextfd() {
            for (var e = 0; e <= ye.MAX_OPEN_FDS; e++)
              if (!ye.streams[e]) return e;
            throw new ye.ErrnoError(33);
          },
          getStreamChecked(e) {
            var r = ye.getStream(e);
            if (!r) throw new ye.ErrnoError(8);
            return r;
          },
          getStream: (e) => ye.streams[e],
          createStream: (e, r = -1) => (
            (e = Object.assign(new ye.FSStream(), e)),
            -1 == r && (r = ye.nextfd()),
            (e.fd = r),
            (ye.streams[r] = e),
            e
          ...
          makedev: (e, r) => (e << 8) | r,
          registerDevice(e, r) {
            ye.devices[e] = { stream_ops: r };
          },
          getDevice: (e) => ye.devices[e],
          getMounts(e) {
          ...
          mount(e, r, t) {
            var n,
              o = '/' === t,
              a = !t;
            if (o && ye.root) throw new ye.ErrnoError(10);
            if (!o && !a) {
              var i = ye.lookupPath(t, { follow_mount: !1 });
              if (((t = i.path), (n = i.node), ye.isMountpoint(n)))
                throw new ye.ErrnoError(10);
              if (!ye.isDir(n.mode)) throw new ye.ErrnoError(54);
            }
          ...
          unmount(e) {
            var r = ye.lookupPath(e, { follow_mount: !1 });
            if (!ye.isMountpoint(r.node)) throw new ye.ErrnoError(28);
            var t = r.node,
              n = t.mounted,
              o = ye.getMounts(n);
          ...
          mknod(e, r, t) {
            var n = ye.lookupPath(e, { parent: !0 }).node,
              o = ee.basename(e);
            if (!o || '.' === o || '..' === o) throw new ye.ErrnoError(28);
            var a = ye.mayCreate(n, o);
            if (a) throw new ye.ErrnoError(a);
            if (!n.node_ops.mknod) throw new ye.ErrnoError(63);
          ...
          symlink(e, r) {
            ...
            var t = ye.lookupPath(r, { parent: !0 }).node;
            if (!t) throw new ye.ErrnoError(44);
            var n = ee.basename(r),
              o = ye.mayCreate(t, n);
            if (o) throw new ye.ErrnoError(o);
            if (!t.node_ops.symlink) throw new ye.ErrnoError(63);
          ...
          rename(e, r) {
            var t,
              ...
              s = ee.basename(r);
            if (
              ((t = ye.lookupPath(e, { parent: !0 }).node),
              (n = ye.lookupPath(r, { parent: !0 }).node),
              !t || !n)
            )
              throw new ye.ErrnoError(44);
            if (t.mount !== n.mount) throw new ye.ErrnoError(75);
            var l,
              u = ye.lookupNode(t, i),
              d = te.relative(e, a);
            if ('.' !== d.charAt(0)) throw new ye.ErrnoError(28);
            if ('.' !== (d = te.relative(r, o)).charAt(0))
              throw new ye.ErrnoError(55);
            try {
              l = ye.lookupNode(n, s);
            } catch (e) {}
            if (u !== l) {
              var c = ye.isDir(u.mode),
                f = ye.mayDelete(t, i, c);
              if (f) throw new ye.ErrnoError(f);
              if ((f = l ? ye.mayDelete(n, s, c) : ye.mayCreate(n, s)))
                throw new ye.ErrnoError(f);
              if (!t.node_ops.rename) throw new ye.ErrnoError(63);
              if (ye.isMountpoint(u) || (l && ye.isMountpoint(l)))
                throw new ye.ErrnoError(10);
              if (n !== t && (f = ye.nodePermissions(t, 'w')))
                throw new ye.ErrnoError(f);
              ye.hashRemoveNode(u);
              try {
          ...
          rmdir(e) {
            var r = ye.lookupPath(e, { parent: !0 }).node,
              t = ee.basename(e),
              n = ye.lookupNode(r, t),
              o = ye.mayDelete(r, t, !0);
            if (o) throw new ye.ErrnoError(o);
          ...
          readdir(e) {
            ...
            if (!r.node_ops.readdir) throw new ye.ErrnoError(54);
            return r.node_ops.readdir(r);
          },
          unlink(e) {
            var r = ye.lookupPath(e, { parent: !0 }).node;
            if (!r) throw new ye.ErrnoError(44);
            var t = ee.basename(e),
              n = ye.lookupNode(r, t),
              o = ye.mayDelete(r, t, !1);
            if (o) throw new ye.ErrnoError(o);
          ...
          readlink(e) {
            ...
            if (!r) throw new ye.ErrnoError(44);
            if (!r.node_ops.readlink) throw new ye.ErrnoError(28);
            return te.resolve(ye.getPath(r.parent), r.node_ops.readlink(r));
          },
          stat(e, r) {
            var t = ye.lookupPath(e, { follow: !r }).node;
            if (!t) throw new ye.ErrnoError(44);
            if (!t.node_ops.getattr) throw new ye.ErrnoError(63);
          ...
          chmod(e, r, t) {
            var n;
            'string' == typeof e
              ? (n = ye.lookupPath(e, { follow: !t }).node)
              : (n = e);
            if (!n.node_ops.setattr) throw new ye.ErrnoError(63);
          ...
          fchmod(e, r) {
            var t = ye.getStreamChecked(e);
            ye.chmod(t.node, r);
          },
          chown(e, r, t, n) {
            var o;
            'string' == typeof e
              ? (o = ye.lookupPath(e, { follow: !n }).node)
              : (o = e);
            if (!o.node_ops.setattr) throw new ye.ErrnoError(63);
          ...
          fchown(e, r, t) {
            var n = ye.getStreamChecked(e);
            ye.chown(n.node, r, t);
          },
          truncate(e, r) {
            if (r < 0) throw new ye.ErrnoError(28);
            var t;
            'string' == typeof e
              ? (t = ye.lookupPath(e, { follow: !0 }).node)
              : (t = e);
            if (!t.node_ops.setattr) throw new ye.ErrnoError(63);
            if (ye.isDir(t.mode)) throw new ye.ErrnoError(31);
            if (!ye.isFile(t.mode)) throw new ye.ErrnoError(28);
            var n = ye.nodePermissions(t, 'w');
            if (n) throw new ye.ErrnoError(n);
            t.node_ops.setattr(t, { size: r, timestamp: Date.now() });
          },
          ftruncate(e, r) {
            var t = ye.getStreamChecked(e);
            if (0 == (2097155 & t.flags)) throw new ye.ErrnoError(28);
            ye.truncate(t.node, r);
          },
          utime(e, r, t) {
            var n = ye.lookupPath(e, { follow: !0 }).node;
            n.node_ops.setattr(n, { timestamp: Math.max(r, t) });
          },
          open(e, r, t) {
            if ('' === e) throw new ye.ErrnoError(44);
            var n;
            if (
              ((t =
                64 &
              ...
              e = ee.normalize(e);
              try {
                n = ye.lookupPath(e, { follow: !(131072 & r) }).node;
              } catch (e) {}
            }
            var o = !1;
            if (64 & r)
            ...
            if (
              ...
              65536 & r && !ye.isDir(n.mode))
            )
              throw new ye.ErrnoError(54);
            if (!o) {
            ...
            return (
              ...
              !i.logReadFiles ||
                1 & r ||
                (ye.readFiles || (ye.readFiles = {}),
                e in ye.readFiles || (ye.readFiles[e] = 1)),
              s
            );
          },
          close(e) {
          ...
          llseek(e, r, t) {
            ...
            if (!e.seekable || !e.stream_ops.llseek)
              throw new ye.ErrnoError(70);
            if (0 != t && 1 != t && 2 != t) throw new ye.ErrnoError(28);
            return (
          ...
          read(e, r, t, n, o) {
            ...
            if (ye.isClosed(e)) throw new ye.ErrnoError(8);
            if (1 == (2097155 & e.flags)) throw new ye.ErrnoError(8);
            if (ye.isDir(e.node.mode)) throw new ye.ErrnoError(31);
            if (!e.stream_ops.read) throw new ye.ErrnoError(28);
            var a = void 0 !== o;
            if (a) {
          ...
          write(e, r, t, n, o, a) {
            if (n < 0 || o < 0) throw new ye.ErrnoError(28);
            if (ye.isClosed(e)) throw new ye.ErrnoError(8);
            if (0 == (2097155 & e.flags)) throw new ye.ErrnoError(8);
            if (ye.isDir(e.node.mode)) throw new ye.ErrnoError(31);
            if (!e.stream_ops.write) throw new ye.ErrnoError(28);
            e.seekable && 1024 & e.flags && ye.llseek(e, 0, 2);
            var i = void 0 !== o;
            if (i) {
              if (!e.seekable) throw new ye.ErrnoError(70);
            } else o = e.position;
          ...
          allocate(e, r, t) {
            if (ye.isClosed(e)) throw new ye.ErrnoError(8);
            if (r < 0 || t <= 0) throw new ye.ErrnoError(28);
            if (0 == (2097155 & e.flags)) throw new ye.ErrnoError(8);
            if (!ye.isFile(e.node.mode) && !ye.isDir(e.node.mode))
              throw new ye.ErrnoError(43);
            if (!e.stream_ops.allocate) throw new ye.ErrnoError(138);
            e.stream_ops.allocate(e, r, t);
          },
          mmap(e, r, t, n, o) {
            if (0 != (2 & n) && 0 == (2 & o) && 2 != (2097155 & e.flags))
              throw new ye.ErrnoError(2);
            if (1 == (2097155 & e.flags)) throw new ye.ErrnoError(2);
            if (!e.stream_ops.mmap) throw new ye.ErrnoError(43);
            return e.stream_ops.mmap(e, r, t, n, o);
          },
          msync: (e, r, t, n, o) =>
            e.stream_ops.msync ? e.stream_ops.msync(e, r, t, n, o) : 0,
          ioctl(e, r, t) {
            if (!e.stream_ops.ioctl) throw new ye.ErrnoError(59);
          ...
          writeFile(e, r, t = {}) {
            t.flags = t.flags || 577;
            var n = ye.open(e, t.flags, t.mode);
            if ('string' == typeof r) {
              var o = new Uint8Array(ie(r) + 1),
                a = se(r, o, 0, o.length);
              ye.write(n, o, 0, a, void 0, t.canOwn);
            } else {
              if (!ArrayBuffer.isView(r))
                throw new Error('Unsupported data type');
              ye.write(n, r, 0, r.byteLength, void 0, t.canOwn);
            }
            ye.close(n);
          },
          cwd: () => ye.currentPath,
          chdir(e) {
            var r = ye.lookupPath(e, { follow: !0 });
            if (null === r.node) throw new ye.ErrnoError(44);
            if (!ye.isDir(r.node.mode)) throw new ye.ErrnoError(54);
            var t = ye.nodePermissions(r.node, 'x');
            if (t) throw new ye.ErrnoError(t);
          ...
          createDefaultDevices() {
            (ye.mkdir('/dev'),
              ...
              ye.mkdev('/dev/null', ye.makedev(1, 3)),
          ...
          createSpecialDirectories() {
            ...
            (ye.mkdir('/proc/self/fd'),
              ye.mount(
                {
                  mount() {
                    var r = ye.createNode(e, 'fd', 16895, 73);
                    return (
                      (r.node_ops = {
                        lookup(e, r) {
                          var t = +r,
                            n = ye.getStreamChecked(t),
                            o = {
                              parent: null,
          ...
          createStandardStreams() {
            (i.stdin
              ...
              i.stdout
                ? ye.createDevice('/dev', 'stdout', null, i.stdout)
          ...
          quit() {
            ...
            for (var e = 0; e < ye.streams.length; e++) {
              var r = ye.streams[e];
              r && ye.close(r);
            }
          },
          findObject(e, r) {
            var t = ye.analyzePath(e, r);
            return t.exists ? t.object : null;
          },
          analyzePath(e, r) {
            try {
              e = (n = ye.lookupPath(e, { follow: !r })).path;
            } catch (e) {}
            var t = {
              isRoot: !1,
              exists: !1,
          ...
          createPath(e, r, t, n) {
            e = 'string' == typeof e ? e : ye.getPath(e);
          ...
          createFile(e, r, t, n, o) {
            var a = ee.join2('string' == typeof e ? e : ye.getPath(e), r),
              i = me(n, o);
            return ye.create(a, i);
          },
          ...
          createDevice(e, r, t, n) {
            var o = ee.join2('string' == typeof e ? e : ye.getPath(e), r),
              a = me(!!t, !!n);
            ye.createDevice.major || (ye.createDevice.major = 64);
            var i = ye.makedev(ye.createDevice.major++, 0);
            return (
              ye.registerDevice(i, {
                open(e) {
                  e.seekable = !1;
        ...
        we = {
          DEFAULT_POLLMASK: 5,
          calculateAt(e, r, t) {
            if (ee.isAbs(r)) return r;
            var n;
            -100 === e ? (n = ye.cwd()) : (n = we.getStreamFromFD(e).path);
            if (0 == r.length) {
              if (!t) throw new ye.ErrnoError(44);
              return n;
            }
          ...
          doMsync(e, r, t, n, o) {
            if (!ye.isFile(r.node.mode)) throw new ye.ErrnoError(43);
            if (2 & n) return 0;
            var a = b.slice(e, e + t);
            ye.msync(r, a, o, t, n);
          },
          getStreamFromFD: (e) => ye.getStreamChecked(e),
          varargs: void 0,
          getStr: (e) => ge(e),
        };
      function Ee() {
      ...
      var ke = (e, r, t) => se(e, b, r, t);
      var Ce,
        $e,
        Pe,
        Te,
        De,
        Fe = (e, r) => Object.defineProperty(r, 'name', { value: e }),
        Se = [],
        Me = [],
        Ae = (e) => {
          throw new Ce(e);
        },
        je = () => Me.length / 2 - 5 - Se.length,
        Oe = (e) => (e || Ae('Cannot use deleted val. handle = ' + e), Me[e]),
        Re = (e) => {
          switch (e) {
            case void 0:
              return 2;
        ...
        ze = (e) => {
          for (var r = '', t = e; b[t]; ) r += Pe[b[t++]];
          return r;
        },
        xe = () => Object.keys(Be).length,
        Ue = () => {
          var e = [];
          for (var r in Be) Be.hasOwnProperty(r) && e.push(Be[r]);
          return e;
        },
        We = [],
        Le = () => {
        ...
        er = (e, r) => (
          ...
          (r.count = { value: 1 }),
          tr(Object.create(e, { $$: { value: r, writable: !0 } }))
        );
      function rr(e) {
        ...
        var l = Ke(r, this.registeredClass, a.registeredClass);
        return null === l
          ? o.call(this)
          : this.isSmartPointer
            ? er(a.registeredClass.instancePrototype, {
                ptrType: a,
                ptr: l,
                smartPtrType: this,
                smartPtr: e,
              })
            : er(a.registeredClass.instancePrototype, { ptrType: a, ptr: l });
      }
      var tr = (e) =>
      ...
      var ir = {},
        ...
        lr = (e, r, t) => {
          function n(r) {
            ...
            for (var o = 0; o < e.length; ++o) ur(e[o], n[o]);
          }
      ...
      function ur(e, r, t = {}) {
        ...
        return (function (e, r, t = {}) {
          var n = r.name;
          if (
            (e || Ae(`type "${n}" must have a positive integer typeid pointer`),
            Ve.hasOwnProperty(e))
          ) {
      ...
      var dr = 8,
        cr = (e) => {
          Ae(e.$$.ptrType.registeredClass.name + ' instance already deleted');
        };
      function fr() {}
      var hr = (e, r, t) => {
        ...
        pr = (e, r, t) => {
          i.hasOwnProperty(e)
            ? ((void 0 === t ||
                (void 0 !== i[e].overloadTable &&
                  void 0 !== i[e].overloadTable[t])) &&
      ...
      var _r,
        ...
        Pr = (e, r) => {
          ...
          return (
            'function' != typeof o &&
              Ae(`unknown function pointer with signature ${e}: ${r}`),
            o
          );
        },
        Tr = (e, r) => {
      ...
      function Dr(e) {
        for (var r = 1; r < e.length; ++r)
          if (null !== e[r] && void 0 === e[r].destructorFunction) return !0;
        return !1;
      }
      function Fr(e, r) {
        ...
        var t = Fe(e.name || 'unknownFunctionName', function () {});
        t.prototype = e.prototype;
        var n = new t(),
          o = e.apply(n, r);
        return o instanceof Object ? o : n;
      }
      function Sr(e, r, t, n, o, a) {
        var i = r.length;
        i < 2 &&
          Ae(
        ...
        for (
          var s = null !== r[1] && null !== t,
            l = Dr(r),
            u = 'void' !== r[0].name,
            d = [e, Ae, n, o, or, r[0], r[1]],
            c = 0;
          c < i - 2;
          ++c
        )
          d.push(r[c + 2]);
        if (!l)
          for (c = s ? 1 : 2; c < r.length; ++c)
            null !== r[c].destructorFunction && d.push(r[c].destructorFunction);
        let [f, h] = (function (e, r, t, n) {
          for (
            var o = Dr(e), a = e.length, i = '', s = '', l = 0;
            l < a - 2;
            ++l
          )
            ((i += (0 !== l ? ', ' : '') + 'arg' + l),
          ...
          for (
            r &&
              (u +=
                "var thisWired = classParam['toWireType'](" + d + ', this);\n'),
              l = 0;
            l < a - 2;
            ++l
          )
          ...
          if (
            ...
            for (l = r ? 1 : 2; l < e.length; ++l) {
              var f = 1 === l ? 'thisWired' : 'arg' + (l - 2) + 'Wired';
              null !== e[l].destructorFunction &&
                ((u += `${f}_dtor(${f});\n`), c.push(`${f}_dtor`));
            }
          return (
            t && (u += "var ret = retType['fromWireType'](rv);\nreturn ret;\n"),
            [c, (u += '}\n')]
          );
        })(r, s, u, a);
        f.push(h);
        var p = Fr(Function, f)(...d);
        return Fe(e, p);
      }
      var Mr = (e, r) => {
          for (var t = [], n = 0; n < e; n++) t.push(P[(r + 4 * n) >> 2]);
          return t;
        },
        Ar = (e) => {
          const r = (e = e.trim()).indexOf('(');
          return -1 !== r ? e.substr(0, r) : e;
        },
        jr = (e, r, t) => (
          e instanceof Object || Ae(`${t} with invalid "this": ${e}`),
          e instanceof r.registeredClass.constructor ||
            Ae(`${t} incompatible with "this" of type ${e.constructor.name}`),
          e.$$.ptr ||
            Ae(`cannot call emscripten binding method ${t} on deleted object`),
          vr(e.$$.ptr, e.$$.ptrType.registeredClass, r.registeredClass)
        ),
        Or = (e) => {
          e > 9 && 0 == --Me[e + 1] && ((Me[e] = void 0), Se.push(e));
        },
        Rr = {
          name: 'emscripten::val',
          fromWireType: (e) => {
        ...
        Ur = (e, r, t) => {
          switch (r) {
            case 1:
              return t ? (e) => _[e] : (e) => b[e];
            case 2:
              return t ? (e) => k[e >> 1] : (e) => C[e >> 1];
            case 4:
              return t ? (e) => $[e >> 2] : (e) => P[e >> 2];
            default:
        ...
        Wr =
          'undefined' != typeof TextDecoder
            ...
            : void 0,
        Lr = (e, r) => {
          for (var t = e, n = t >> 1, o = n + r / 2; !(n >= o) && C[n]; ) ++n;
          if ((t = n << 1) - e > 32 && Wr) return Wr.decode(b.subarray(e, t));
      ...
      Reflect.construct;
      var Zr = (e) => e % 4 == 0 && (e % 100 != 0 || e % 400 == 0),
        Qr = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335],
        et = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
        rt = (e) =>
          (Zr(e.getFullYear()) ? Qr : et)[e.getMonth()] + e.getDate() - 1;
      var tt = (e) => Ft(e);
      var nt,
        ot = [],
        at = (e, r, t) => {
      ...
      var ct = {},
        ft = () => {
          if (!ft.strings) {
            ...
            for (var r in ct) void 0 === ct[r] ? delete e[r] : (e[r] = ct[r]);
            var t = [];
      ...
      ((ye.createPreloadedFile = pe),
        ...
        (i.FS_createPreloadedFile = ye.createPreloadedFile),
        (i.FS_unlink = ye.unlink),
        (i.FS_createLazyFile = ye.createLazyFile),
        (i.FS_createDevice = ye.createDevice),
        (Ce = i.BindingError =
          class extends Error {
            constructor(e) {
        ...
        (i.count_emval_handles = je),
        ($e = i.PureVirtualError = Ne(Error, 'PureVirtualError')),
        (() => {
          for (var e = new Array(256), r = 0; r < 256; ++r)
            e[r] = String.fromCharCode(r);
          Pe = e;
        })(),
        (i.getInheritedInstanceCount = xe),
        (i.getLiveInheritedInstances = Ue),
        (i.flushPendingDeletes = Le),
        (i.setDelayFunction = Ie),
        (De = i.InternalError =
          class extends Error {
            constructor(e) {
        ...
        Object.assign(fr.prototype, {
          isAliasOf(e) {
            if (!(this instanceof fr)) return !1;
            if (!(e instanceof fr)) return !1;
      ...
      var _t,
        bt = {
          ...
          la: function (e, r, t, n) {
            try {
              if (((r = we.getStr(r)), (r = we.calculateAt(e, r)), -8 & t))
                return -28;
              var o = ye.lookupPath(r, { follow: !0 }).node;
              if (!o) return -44;
              var a = '';
              return (
                4 & t && (a += 'r'),
          ...
          fa: function (e, r) {
            try {
              ...
              return we.doStat(ye.stat, t.path, r);
            } catch (e) {
              if (void 0 === ye || 'ErrnoError' !== e.name) throw e;
              return -e.errno;
            }
          ...
          Q: function (e, r, t) {
            var n = be(r, t);
            try {
              return isNaN(n) ? 61 : (ye.ftruncate(e, n), 0);
            } catch (e) {
              if (void 0 === ye || 'ErrnoError' !== e.name) throw e;
              return -e.errno;
            }
                ...
                case 21508:
                  ...
                  if (n.tty.ops.ioctl_tcsets) {
                    ...
                    var s = $[a >> 2],
                      ...
                      d = $[(a + 12) >> 2],
                      c = [];
                    for (i = 0; i < 32; i++) c.push(_[a + i + 17]);
          ...
          Z: function (e, r, t) {
            try {
              return (
                (r = we.getStr(r)),
                (r = we.calculateAt(e, r)),
                '/' === (r = ee.normalize(r))[r.length - 1] &&
          ...
          ca: function (e, r, t, n) {
            try {
              ...
              return (
                (n &= -6401),
                (r = we.calculateAt(e, r, a)),
                we.doStat(o ? ye.lstat : ye.stat, r, t)
              );
            } catch (e) {
              if (void 0 === ye || 'ErrnoError' !== e.name) throw e;
              return -e.errno;
              ...
              lr([e, r, t], n ? [n] : [], (r) => {
                ...
                var i = Fe(d, function (...e) {
                    ...
                    if (void 0 === c.constructor_body)
                      throw new Ce(d + ' has no accessible constructor');
                    var r = c.constructor_body[e.length];
                    if (void 0 === r)
                      throw new Ce(
                ...
                i.prototype = l;
                var c = new mr(d, i, l, f, t, a, s, u);
                c.baseClass &&
                  ((c.baseClass.__derivedClasses ??= []),
                  c.baseClass.__derivedClasses.push(c));
                var p = new Er(d, c, !0, !1, !1),
                  m = new Er(d + '*', c, !1, !1, !1),
                  v = new Er(d + ' const*', c, !1, !0, !1);
                return (
                  (Ze[e] = { pointerType: m, constPointerType: v }),
                  kr(h, i),
                  [p, m, v]
                );
              }));
          ...
          B: (e, r, t, n, o, a, i, s) => {
            ...
            ((r = ze(r)),
              ...
              lr([], [e], (e) => {
                var n = `${(e = e[0]).name}.${r}`;
                function o() {
                  Tr(`Cannot call ${n} due to unbound types`, l);
                }
                r.startsWith('@@') && (r = Symbol[r.substring(2)]);
                var u = e.registeredClass.constructor;
                return (
                  void 0 === u[r]
                    ? ((o.argCount = t - 1), (u[r] = o))
                    : (hr(u, r, n), (u[r].overloadTable[t - 1] = o)),
                  lr([], l, (o) => {
                    var l = [o[0], null].concat(o.slice(1)),
                      d = Sr(n, l, null, a, i, s);
                    if (
                      (void 0 === u[r].overloadTable
                        ? ((d.argCount = t - 1), (u[r] = d))
                        : (u[r].overloadTable[t - 1] = d),
            ...
            ((o = Pr(n, o)),
              lr([], [e], (e) => {
                ...
                if (
                  ...
                  throw new Ce(
                    `Cannot register multiple constructors with identical number of parameters (${r - 1}) for class '${e.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`
                  );
                return (
                  (e.registeredClass.constructor_body[r - 1] = () => {
                    Tr(`Cannot construct ${e.name} due to unbound types`, i);
                  }),
                  lr(
                    [],
                    i,
                    (n) => (
                      n.splice(1, 0, null),
                      (e.registeredClass.constructor_body[r - 1] = Sr(
                        t,
                        n,
                        null,
                        o,
              ...
              lr([], [e], (e) => {
                ...
                return (
                  ...
                  (void 0 === c.overloadTable &&
                    c.className !== e.name &&
                    c.argCount === t - 2)
                    ? ((o.argCount = t - 2), (o.className = e.name), (d[r] = o))
                    : (hr(d, r, n), (d[r].overloadTable[t - 2] = o)),
                  lr([], u, (o) => {
                    var s = Sr(n, o, e, a, i, l);
                    return (
                      void 0 === d[r].overloadTable
                        ? ((s.argCount = t - 2), (d[r] = s))
                        : (d[r].overloadTable[t - 2] = s),
                      []
                    );
                  }),
                  []
            ...
            ((r = ze(r)),
              ...
              lr([], [e], (e) => {
                var n = `${(e = e[0]).name}.${r}`,
                  d = {
                    get() {
                      Tr(`Cannot access ${n} due to unbound types`, [t, i]);
                    },
                    enumerable: !0,
                    configurable: !0,
                  };
                return (
                  (d.set = l
                    ? () =>
                        Tr(`Cannot access ${n} due to unbound types`, [t, i])
                    : (e) => Ae(n + ' is a read-only property')),
          ...
          v: (e, r, t) => {
            ...
            ((t = ze(t)),
              2 === r
                ...
                : 4 === r &&
                  ((n = Hr), (o = Vr), (i = qr), (a = (e) => P[e >> 2])),
              ur(e, {
                name: t,
                fromWireType: (e) => {
                  for (var t, o = P[e >> 2], i = e + 4, s = 0; s <= o; ++s) {
                    var l = e + 4 + s * r;
                    if (s == o || 0 == a(l)) {
                      var u = n(i, l - i);
                      (void 0 === t
                ...
                toWireType: (e, n) => {
                  'string' != typeof n &&
                    Ae(`Cannot pass non-string to C++ string type ${t}`);
                  var a = i(n),
                    s = $t(4 + a + r);
                  return (
                    (P[s >> 2] = a / r),
          ...
          xa: (e, r, t, n, o, a) => {
            nr[e] = {
              name: ze(r),
              rawConstructor: Pr(t, n),
              rawDestructor: Pr(o, a),
              fields: [],
            };
          },
          D: (e, r, t, n, o, a, i, s, l, u) => {
            nr[e].fields.push({
              fieldName: ze(r),
              getterReturnType: t,
              getter: Pr(n, o),
          ...
          n: (e, r, t) => ((e = Oe(e)), (r = Ye(r, 'emval::as')), Yr(r, t, e)),
          J: (e, r, t, n) => (e = Gr[e])(null, (r = Oe(r)), t, n),
          g: (e, r, t, n, o) => (e = Gr[e])((r = Oe(r)), r[(t = Jr(t))], n, o),
          b: Or,
          q: (e) => (0 === e ? Re(Kr()) : ((e = Jr(e)), Re(Kr()[e]))),
          f: (e, r, t) => {
            var n = ((e, r) => {
                for (var t = new Array(e), n = 0; n < e; ++n)
                  t[n] = Ye(P[(r + 4 * n) >> 2], 'parameter ' + n);
                return t;
              })(e, r),
              o = n.shift();
            e--;
          ...
          K: function (e, r, t, n, o, a, i) {
            var s = be(a, i);
            try {
              var l = we.getStreamFromFD(o);
              2 & t && we.doMsync(e, l, r, n, s);
            } catch (e) {
              if (void 0 === ye || 'ErrnoError' !== e.name) throw e;
              return -e.errno;
            }
          ...
          va: (e, r, t) => {
            ...
            var s = {
              ...
              d = n
                ...
                .replace(/%(.)/g, (e, r) => {
                  let t = l[r];
                  return t ? (u.push(r), `(${t})`) : r;
                })
                .replace(/\s+/g, '\\s*'),
              c = new RegExp('^' + d, 'i').exec(ge(e));
            if (c) {
              var f,
                h = (function () {
                  function e(e, r, t) {
                    ...
                    (h.month =
                      {
                        ...
                        NOV: 10,
                        DEC: 11,
                      }[f.substring(0, 3).toUpperCase()] || 0),
                (f = p('d')))
              )
                h.day = yt(f);
              else if ((f = p('j')))
                for (var y = yt(f), g = Zr(h.year), w = 0; w < 12; ++w) {
                  var E = ht(g ? pt : mt, w - 1);
                  y <= E + (g ? pt : mt)[w] && (h.day = y - E);
                }
              else if ((f = p('a'))) {
                var _ = f.substring(0, 3).toUpperCase();
                if ((f = p('U'))) {
                  var b = {
                      SUN: 0,
                      MON: 1,
              ...
              return (
                ...
                ($[(t + 12) >> 2] = D.getDate()),
                ($[(t + 16) >> 2] = D.getMonth()),
                ($[(t + 20) >> 2] = D.getFullYear() - 1900),
                ($[(t + 24) >> 2] = D.getDay()),
                ($[(t + 28) >> 2] =
                  ht(Zr(D.getFullYear()) ? pt : mt, D.getMonth() - 1) +
                  D.getDate() -
                  1),
                ($[(t + 32) >> 2] = 0),
                ($[(t + 36) >> 2] = h.gmtoff),
          ...
          return (
            ...
            'function' != typeof fetch
              ...
              : fetch(r, { credentials: 'same-origin' }).then((e) =>
                  WebAssembly.instantiateStreaming(e, t).then(o, function (e) {
                    return (
      ...
      ((i.dynCall_jiji = (e, r, t, n, o) =>
        ...
        (i.dynCall_viij = (e, r, t, n, o) =>
          (i.dynCall_viij = kt.Ma)(e, r, t, n, o)),
        (i.dynCall_iij = (e, r, t, n) => (i.dynCall_iij = kt.Na)(e, r, t, n)),
        (i.dynCall_iiji = (e, r, t, n, o) =>
          (i.dynCall_iiji = kt.Oa)(e, r, t, n, o)),
        (i.dynCall_jji = (e, r, t, n) => (i.dynCall_jji = kt.Pa)(e, r, t, n)),
        (i.dynCall_iji = (e, r, t, n) => (i.dynCall_iji = kt.Qa)(e, r, t, n)),
        (i.dynCall_viijj = (e, r, t, n, o, a, s) =>
          (i.dynCall_viijj = kt.Ra)(e, r, t, n, o, a, s)),
        (i.dynCall_iiij = (e, r, t, n, o) =>
          (i.dynCall_iiij = kt.Sa)(e, r, t, n, o)),
        (i.dynCall_vij = (e, r, t, n) => (i.dynCall_vij = kt.Ta)(e, r, t, n)),
        (i.dynCall_viiiji = (e, r, t, n, o, a, s) =>
          (i.dynCall_viiiji = kt.Ua)(e, r, t, n, o, a, s)),
        (i.dynCall_viijii = (e, r, t, n, o, a, s) =>
          (i.dynCall_viijii = kt.Va)(e, r, t, n, o, a, s)),
        (i.dynCall_viji = (e, r, t, n, o) =>
          (i.dynCall_viji = kt.Wa)(e, r, t, n, o)),
        (i.dynCall_iiiijij = (e, r, t, n, o, a, s, l, u) =>
          (i.dynCall_iiiijij = kt.Xa)(e, r, t, n, o, a, s, l, u)),
        (i.dynCall_jij = (e, r, t, n) => (i.dynCall_jij = kt.Ya)(e, r, t, n)),
        (i.dynCall_iiiij = (e, r, t, n, o, a) =>
          (i.dynCall_iiiij = kt.Za)(e, r, t, n, o, a)),
        (i.dynCall_iiiiij = (e, r, t, n, o, a, s) =>
          (i.dynCall_iiiiij = kt._a)(e, r, t, n, o, a, s)),
        (i.dynCall_iiiiijj = (e, r, t, n, o, a, s, l, u) =>
      ...
      function St() {
        function e() {
          _t ||
            ...
            F ||
              ((R = !0),
              i.noFSInit || ye.init.initialized || ye.init(),
              (ye.ignorePermissions = !1),
              ue.init(),
              Z(j),
              t(i),
      ...
      if (
        ((i.addRunDependency = U),
        (i.removeRunDependency = W),
        (i.FS_createPreloadedFile = pe),
        (i.FS_unlink = (e) => ye.unlink(e)),
        (i.FS_createPath = gt),
        (i.FS_createDevice = Et),
        (i.FS = ye),
