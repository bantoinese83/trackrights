...
const phrases = [
  {
    highlight: 'TrackRights.com',
    rest: ' - Protecting you from the sharks of the music industry',
    subtext: 'Your trusted partner in legal matters',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Navigating the legal waters of music',
    subtext: 'Expert guidance for music professionals',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Your lifeline in the sea of contracts',
    subtext: 'Simplifying complex legal terms',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Keeping you afloat in the music business',
    subtext: 'Ensuring your rights are protected',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Your legal life raft',
    subtext: 'Comprehensive contract analysis',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Swimming with you through legal waters',
    subtext: 'Personalized legal support',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Your anchor in the music industry',
    subtext: 'Stability in your legal affairs',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Guarding you against legal predators',
    subtext: 'Protecting your interests',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Your compass in the legal ocean',
    subtext: 'Navigating legal complexities',
  },
  {
    highlight: 'TrackRights.com',
    rest: ' - Steering you clear of legal troubles',
    subtext: 'Avoiding potential pitfalls',
  },
];
...
export function SharkBanner() {
  ...
  useCallback(
    (newPhrase: number) => {
      ...
      if (
        diff > 0 ||
        (newPhrase === 0 && currentPhrase === phrases.length - 1)
      ) {
  ...
  return (
    ...
    >
      ...
      >
        <source
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/sharks-Y934nNoxgt5xiXPxos3qfeXyIgGA8Z.mp4"
          type="video/mp4"
        />
      </video>
