...
const featureList: Feature[] = [
  {
    icon: FileText,
    text: 'Upload your music contract',
  },
  {
    icon: Sparkles,
    text: 'AI analyzes and simplifies terms',
  },
  {
    icon: Shield,
    text: 'Get producer-friendly insights',
  },
  {
    icon: ArrowRight,
  ...
  {
    icon: Shield,
    text: 'Protect your interests',
  },
  {
    icon: ArrowRight,
    text: 'Negotiate better deals',
  },
  {
    icon: Calculator,
    text: 'Use the Royalty Calculator',
  },
  {
    icon: Music,
    text: 'Generate music contracts with 20+ categories',
  },
];
