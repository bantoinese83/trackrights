...
function n(e, t) {
  ...
  const r = new Promise(function (o, r) {
    n = {
      ...
      promise: null,
      resolve: (t) => {
        n.isDone || ((n.isDone = !0), o(t), e && e());
      },
      reject: (e) => {
        n.isDone || ((n.isDone = !0), r(e), t && t());
      },
    };
  });
  n.promise = r;
...
function s(e) {
  (function (e) {
    return void 0 !== e[o];
  })(e) || Ce(!1, 'Promise is not controllable');
}
const i = 'MONO_WASM: ';
function a(e, ...t) {
  je.diagnosticTracing && console.debug(i + e, ...t);
}
function l(e, ...t) {
  console.info(i + e, ...t);
}
...
function m(e, t, o) {
  ...
  for (const e of ['log', ...i]) r[e] = s(`console.${e}`, l, !0);
}
const h = {},
  p = {},
  g = {};
...
function v() {
  ...
  console.groupCollapsed(
    ...
    e.length &&
      (console.groupCollapsed(`Loaded ${j(o)} resources from cache`),
      console.table(g),
      console.groupEnd()),
    t.length &&
...
function D(e) {
  return (
    'string' != typeof e && Ce(!1, 'url must be a string'),
    !O(e) &&
      0 !== e.indexOf('./') &&
      0 !== e.indexOf('../') &&
      globalThis.URL &&
...
const $ = [],
  ...
  N = { ...U, 'js-module-library-initializer': !0 },
  P = { ...U, dotnetwasm: !0, heap: !0, manifest: !0 },
  z = { ...N, manifest: !0 },
  F = { ...N, dotnetwasm: !0 },
  W = { dotnetwasm: !0, symbols: !0 },
  B = { resource: !0, assembly: !0, pdb: !0, heap: !0, icu: !0 },
  V = { ...N, dotnetwasm: !0, symbols: !0 };
function q(e) {
  return !('icu' == e.behavior && e.name != je.preferredIcuAsset);
}
function J(e, t, o) {
  ...
  if (((t.resolvedUrl = je.locateFile(t.name)), U[t.behavior])) {
    ...
    e
      ? ('string' != typeof e &&
        ...
        (t.resolvedUrl = e))
      : (t.resolvedUrl = ee(t.resolvedUrl, t.behavior));
...
async function Z() {
  ...
  try {
    ...
    for (const e of $)
      if (Re.loadedMemorySnapshotSize) {
        if (
          (ie(e),
          'resource' == e.behavior ||
            'assembly' == e.behavior ||
      ...
      o.push(
        (async () => {
          ...
          if (e.buffer) {
            ...
            W[e.behavior]
              ? ('symbols' === e.behavior &&
                  (await Re.instantiate_symbols_asset(e), ie(e)),
                W[e.behavior] && ++je.actual_downloaded_assets_count)
              : (e.isOptional ||
                  Ce(!1, 'Expected asset to have the downloaded buffer'),
                !F[e.behavior] && q(e) && je.expected_downloaded_assets_count--,
                !V[e.behavior] &&
                  q(e) &&
                  je.expected_instantiated_assets_count--);
        })()
      );
    Promise.all(o)
      .then(() => {
        Re.allAssetsInMemory.promise_control.resolve();
      })
      .catch((e) => {
        throw (je.err('Error in mono_download_assets: ' + e), Me(1, e), e);
      });
  } catch (e) {
    throw (je.err('Error in mono_download_assets: ' + e), e);
  }
}
async function G(e) {
  const t = await Y(e);
...
async function Y(e) {
  try {
    ...
    if (!je.enableDownloadRetry) throw t;
    if (Ee || ye) throw t;
    ...
    try {
      ...
      return (
        ...
        await (100, new Promise((e) => globalThis.setTimeout(e, 100))),
...
async function K(e) {
  ...
  try {
    ...
    const t = await (async function (e) {
      ...
      const t =
        e.loadRemote && je.config.remoteSources
          ? je.config.remoteSources
          : [''];
      let o;
      for (let n of t) {
        (n = n.trim()), './' === n && (n = '');
        ...
        e.name === t
          ...
          : a(`Attempting to download '${t}' for ${e.name}`);
        try {
          e.resolvedUrl = t;
          const n = ne(e);
          if (
      ...
      const n =
        e.isOptional ||
        (e.name.match(/\.pdb$/) && je.config.ignorePdbLoadErrors);
      if ((o || Ce(!1, `Response undefined ${e.name}`), !n)) {
        const t = new Error(
    ...
    return t
      ? (W[e.behavior] ||
          ...
          ++je.actual_downloaded_assets_count),
        e)
      : e;
  } finally {
...
function X(e, t) {
  let o;
  return (
    null == t && Ce(!1, `sourcePrefix must be provided for ${e.name}`),
    e.resolvedUrl
      ? (o = e.resolvedUrl)
      : ((o =
          '' === t
            ? 'assembly' === e.behavior || 'pdb' === e.behavior
              ...
              : 'resource' === e.behavior && e.culture && '' !== e.culture
                ...
                : e.name
            : t + e.name),
        (o = ee(je.locateFile(o), e.behavior))),
    (o && 'string' == typeof o) ||
      Ce(!1, 'attemptUrl need to be path or url string'),
    o
  );
}
function ee(e, t) {
...
function ne(e) {
  try {
    e.resolvedUrl || Ce(!1, "Request's resolvedUrl must be set");
        ...
        return (
          t ||
            ((t = await (function (e) {
              ...
              const o = {};
              return (
                je.config.disableNoCacheFetch || (o.cache = 'no-cache'),
                e.useCredentials
                  ? (o.credentials = 'include')
                  : !je.config.disableIntegrityCheck &&
                    e.hash &&
                    (o.integrity = e.hash),
                je.fetch_like(t, o)
              );
...
function se(e) {
  ...
  if (je.loadBootResource) {
    const o = null !== (t = e.hash) && void 0 !== t ? t : '',
      ...
      r = re[e.behavior];
    if (r) {
      const t = je.loadBootResource(r, e.name, n, o, e.behavior);
...
async function le(e) {
  ...
  await Promise.all(
    t.map((e) =>
      (async function (e) {
        try {
          const t = ee(je.locateFile(e), 'js-module-library-initializer');
          a(`Attempting to import '${t}' for ${e}`);
          const o = await import(t);
          je.libraryInitializers.push({ scriptName: e, exports: o });
        } catch (t) {
          u(`Failed to import library initializer '${e}': ${t}`);
        }
      })(e)
    )
  );
...
async function ce(e, t) {
  if (!je.libraryInitializers) return;
  const o = [];
  for (let n = 0; n < je.libraryInitializers.length; n++) {
    const r = je.libraryInitializers[n];
    r.exports[e] && o.push(ue(r.scriptName, e, () => r.exports[e](...t)));
  }
  await Promise.all(o);
}
...
function me(e, t) {
  ...
  return (
    o.config &&
      (e.config || (e.config = {}), (o.config = fe(e.config, o.config))),
    Object.assign(e, o)
  );
}
function he(e, t) {
  ...
  return (
    ...
    void 0 !== o.vfs && (o.vfs = pe(e.vfs || {}, o.vfs || {})),
    Object.assign(e, o)
  );
}
function pe(e, t) {
...
function ge() {
  ...
  if (
    ...
    a('config.assets is deprecated, use config.resources instead');
  ...
  (je.assertAfterExit = e.assertAfterExit = e.assertAfterExit || !_e),
    ...
    void 0 === e.diagnosticTracing &&
      'Debug' === de &&
      (e.diagnosticTracing = !0),
    e.applicationCulture &&
      (e.environmentVariables.LANG = `${e.applicationCulture}.UTF-8`),
    (Re.diagnosticTracing = je.diagnosticTracing = !!e.diagnosticTracing),
    (Re.waitForDebugger = e.waitForDebugger),
    (e.startupMemoryCache = !!e.startupMemoryCache),
    e.startupMemoryCache &&
      Re.waitForDebugger &&
      (a('Disabling startupMemoryCache because waitForDebugger is set'),
      (e.startupMemoryCache = !1)),
    (Re.enablePerfMeasure =
      !!e.browserProfilerOptions &&
      globalThis.performance &&
      'function' == typeof globalThis.performance.measure),
    (je.maxParallelDownloads =
      e.maxParallelDownloads || je.maxParallelDownloads),
...
let be = !1;
function we() {
  return !!globalThis.navigator && (je.isChromium || je.isFirefox);
}
const ye =
    'object' == typeof process &&
    'object' == typeof process.versions &&
    'string' == typeof process.versions.node,
  ve = 'function' == typeof importScripts,
  _e = 'object' == typeof window || (ve && !ye),
  Ee = !_e && !ye && !ve;
let Re = {},
  je = {},
  Se = {},
...
function Me(e, t) {
  ...
  e = n && 'number' == typeof t.status ? t.status : e;
  const r = n && 'string' == typeof t.message ? t.message : '' + t;
  if (
    (((t = n
      ? t
      : Re.ExitStatus
        ? new Re.ExitStatus(e)
        : new Error('Exit with code ' + e + ' ' + r)).status = e),
    t.message || (t.message = r),
    t.stack || (t.stack = new Error().stack || ''),
    (t.silent = !0),
    !Te())
  ) {
    try {
      Re.runtimeReady ||
        ...
        (function (e) {
          je.allDownloadsQueued.promise_control.reject(e),
            ...
            je.memorySnapshotSkippedOrDone.promise_control.reject(e),
            Re.dotnetReady &&
              (Re.dotnetReady.promise_control.reject(e),
              Re.afterInstantiateWasm.promise_control.reject(e),
              Re.beforePreInit.promise_control.reject(e),
              Re.afterPreInit.promise_control.reject(e),
        ...
        (function (e, t) {
          if (0 !== e && t) {
            const e = Re.ExitStatus && t instanceof Re.ExitStatus ? a : d;
            'string' == typeof t
              ? e(t)
              : t.stack && t.message
                ? Re.stringify_as_error_with_stack
                  ? e(Re.stringify_as_error_with_stack(t))
                  : e(t.message + '\n' + t.stack)
                : e(JSON.stringify(t));
          }
          if (je.config && je.config.logExitCode)
            if (f) {
              const t = () => {
                0 == f.bufferedAmount
                  ? c('WASM EXIT ' + e)
                  : globalThis.setTimeout(t, 100);
              };
              t();
            } else c('WASM EXIT ' + e);
        })(e, t),
        ...
        try {
          await (async function () {
            try {
              ...
              d(`flushing std* streams failed: ${e}`);
            }
          })();
        } finally {
          $e(e, t);
...
function $e(e, t) {
  if ((Oe() && Re.mono_wasm_exit && Re.mono_wasm_exit(e), 0 !== e || !_e))
    throw (ye && xe.process ? xe.process.exit(e) : Re.quit && Re.quit(e, t), t);
}
!(function (o) {
  ...
  (Ae = !0),
    ...
    (Se = o.api),
    (xe = o.internal),
    Object.assign(Se, { INTERNAL: xe, invokeLibraryInitializers: ce }),
    Object.assign(o.module, {
    ...
    Object.assign(je, {
      ...
      afterConfigLoaded: n(),
      allDownloadsQueued: n(),
      wasmDownloadPromise: n(),
      runtimeModuleLoaded: n(),
      memorySnapshotSkippedOrDone: n(),
      is_exited: Te,
      is_runtime_running: Oe,
      assert_runtime_running: ke,
      mono_exit: Me,
      createPromiseController: n,
      getPromiseController: r,
      assertIsControllablePromise: s,
      mono_download_assets: Z,
      resolve_single_asset_path: Q,
      setup_proxy_console: m,
      logDownloadStatsToConsole: v,
      purgeUnusedCacheEntriesAsync: _,
      retrieve_asset_download: G,
      invokeLibraryInitializers: ce,
...
async function Pe(e) {
  ...
  return (
    await (async function (e) {
      ...
      var n;
      if (
        (o > 0 && (je.modulesUniqueQuery = t.substring(o)),
        (je.scriptUrl = t.replace(/\\/g, '/').replace(/[?#].*/, '')),
        (je.scriptDirectory =
          (n = je.scriptUrl).slice(0, n.lastIndexOf('/')) + '/'),
        (je.locateFile = (e) =>
          'URL' in globalThis && globalThis.URL !== x
            ? new URL(e, je.scriptDirectory).toString()
            : O(e)
              ? e
              : je.scriptDirectory + e),
        (je.fetch_like = A),
        (je.out = console.log),
        (je.err = console.error),
        (je.onDownloadResourceProgress = e.onDownloadResourceProgress),
        _e && globalThis.navigator)
      ) {
        const e = globalThis.navigator,
          t = e.userAgentData && e.userAgentData.brands;
        t && t.length > 0
          ? (je.isChromium = t.some(
              (e) =>
    ...
    Ue.ENVIRONMENT_IS_PTHREAD
      ...
      : (async function () {
          ...
          Ue.configSrc ||
            ...
            (Ue.configSrc = './blazor.boot.json'),
            await (async function (e) {
              var t;
              const o = e.configSrc;
              if (be) await je.afterConfigLoaded.promise;
              else
                try {
                  if (
                    ((be = !0),
                    o &&
                      (a('mono_wasm_load_config'),
                      await (async function (e) {
                        const t = je.locateFile(e.configSrc),
                          o =
                            void 0 !== je.loadBootResource
                              ? je.loadBootResource(
                                  'manifest',
                                  'blazor.boot.json',
                                  t,
                        ...
                        const r = await (async function (e) {
                          ...
                          n &&
                            (o.environmentVariables.DOTNET_MODIFIABLE_ASSEMBLIES =
                              n);
                          const r = e.headers.get('ASPNETCORE-BROWSER-TOOLS');
                          return (
                            r &&
                              (o.environmentVariables.__ASPNETCORE_BROWSER_TOOLS =
                                r),
                            o
                          );
                        })(n);
                        function s(e) {
                          return je.fetch_like(e, {
                            method: 'GET',
                            credentials: 'include',
                            cache: 'no-cache',
                          });
                    ...
                    ge(),
                    await le(
                      null === (t = je.config.resources) || void 0 === t
                        ? void 0
                        : t.modulesAfterConfigLoaded
                    ),
                    await ce('onRuntimeConfigLoaded', [je.config]),
                    e.onConfigLoaded)
                  )
                    try {
                  ...
                  ge(),
                    je.config.startupMemoryCache &&
                      ...
                      Ce(
                        !1,
                        'startupMemoryCache is not supported with Module.instantiateWasm'
                      ),
                    je.afterConfigLoaded.promise_control.resolve(je.config),
                    je.config.startupMemoryCache ||
            ...
            (function () {
              ...
              if (e.assets)
                for (const t of e.assets)
                  'object' != typeof t &&
                    ...
                    'string' != typeof t.name &&
                      Ce(!1, 'asset name must be string'),
                    t.resolvedUrl &&
                      'string' != typeof t.resolvedUrl &&
                      Ce(!1, 'asset resolvedUrl could be string'),
                    t.hash &&
                ...
                if (
                  (o.wasmNative ||
                    Ce(!1, 'resources.wasmNative must be defined'),
                  o.jsModuleNative ||
                    Ce(!1, 'resources.jsModuleNative must be defined'),
                  o.jsModuleRuntime ||
                    Ce(!1, 'resources.jsModuleRuntime must be defined'),
                  J(I, o.wasmNative, 'dotnetwasm'),
                  J(t, o.jsModuleNative, 'js-module-native'),
                  J(t, o.jsModuleRuntime, 'js-module-runtime'),
                  o.assembly)
                )
                ...
                if (0 != e.debugLevel && je.isDebuggingSupported() && o.pdb)
                  for (const e in o.pdb)
                    $.push({ name: e, hash: o.pdb[e], behavior: 'pdb' });
          ...
          await (async function () {
            ...
            Y(Q('dotnetwasm'))
              .then((e) => {
                je.wasmDownloadPromise.promise_control.resolve(e);
              })
              .catch((e) => {
                Me(1, e);
              }),
            setTimeout(() => {
              !(function () {
                if (
                  ...
                  (je.invariantMode =
                    'invariant' == je.config.globalizationMode),
                  !je.invariantMode)
                )
                  if (je.preferredIcuAsset)
                    a(
                      'ICU data archive(s) available, disabling invariant mode'
                    );
                  else {
                    if (
                      'custom' === je.config.globalizationMode ||
                      'all' === je.config.globalizationMode ||
                      'sharded' === je.config.globalizationMode
                    ) {
                      const e =
                ...
                const e = 'DOTNET_SYSTEM_GLOBALIZATION_INVARIANT',
                  ...
                  o = je.config.environmentVariables;
                if (
                  (void 0 === o[t] && 'hybrid' === je.config.globalizationMode
                    ? (o[t] = '1')
                    : void 0 === o[e] && je.invariantMode && (o[e] = '1'),
                  void 0 === o.TZ)
                )
                  try {
                    const e =
          ...
          return (
            await Fe(o),
            await Re.dotnetReady.promise,
            await le(
              null === (e = je.config.resources) || void 0 === e
                ? void 0
                : e.modulesAfterRuntimeReady
            ),
            await ce('onRuntimeReady', [De.api]),
            Se
          );
        })()
  );
...
function ze() {
  const e = Q('js-module-runtime'),
    t = Q('js-module-native');
  let o, n;
  return (
    'object' == typeof e.moduleExports
      ? (o = e.moduleExports)
      : (a(`Attempting to import '${e.resolvedUrl}' for ${e.name}`),
        (o = import(e.resolvedUrl))),
    'object' == typeof t.moduleExports
      ? (n = t.moduleExports)
      : (a(`Attempting to import '${t.resolvedUrl}' for ${t.name}`),
        (n = import(t.resolvedUrl))),
    [o, n]
  );
}
async function Fe(e) {
...
const We = new (class {
      ...
      try {
        return (
          _e &&
            ...
            window.addEventListener('error', (t) => e(t, t.error))),
          this
        );
      } catch (e) {
        throw (Me(1, e), e);
    ...
    withConfigSrc(e) {
      try {
        return (
          (e && 'string' == typeof e) || Ce(!1, 'must be file path or URL'),
          me(Ue, { configSrc: e }),
          this
        );
      } catch (e) {
    ...
    withVirtualWorkingDirectory(e) {
      try {
        return (
          (e && 'string' == typeof e) || Ce(!1, 'must be directory path'),
          (this.virtualWorkingDirectory = e),
          this
        );
      } catch (e) {
        throw (Me(1, e), e);
    ...
    withEnvironmentVariables(e) {
      try {
        return (
          (e && 'object' == typeof e) || Ce(!1, 'must be dictionary object'),
          fe(Ne, { environmentVariables: e }),
          this
        );
      } catch (e) {
        throw (Me(1, e), e);
    ...
    withDiagnosticTracing(e) {
      try {
        return (
          'boolean' != typeof e && Ce(!1, 'must be boolean'),
          fe(Ne, { diagnosticTracing: e }),
          this
        );
      } catch (e) {
        throw (Me(1, e), e);
    ...
    withDebugging(e) {
      try {
        return (
          (e && 'number' == typeof e) || Ce(!1, 'must be number'),
          fe(Ne, { debugLevel: e }),
          this
        );
      } catch (e) {
    ...
    withApplicationArguments(...e) {
      try {
        return (
          (e && Array.isArray(e)) || Ce(!1, 'must be array of strings'),
          (this.applicationArguments = e),
          this
        );
      } catch (e) {
        throw (Me(1, e), e);
    ...
    async create() {
      try {
        if (
          (this.instance ||
            (_e &&
              Ue.config.forwardConsoleLogsToWS &&
              void 0 !== globalThis.WebSocket &&
              m('main', globalThis.console, globalThis.location.origin),
            Ue || Ce(!1, 'Null moduleConfig'),
            Ue.config || Ce(!1, 'Null moduleConfig.config'),
            await Pe(Ue),
            (this.instance = De.api)),
    ...
    async run() {
      try {
        if (
          ...
          Ue.config.mainAssemblyName ||
            Ce(!1, 'Null moduleConfig.config.mainAssemblyName'),
