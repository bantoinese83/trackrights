...
const contractForms: ContractForms = {
  ...
  bsa: {
    ...
    fields: {
      influencerName: { label: 'Influencer/Streamer Name', type: 'text' },
      brandName: { label: 'Brand Name', type: 'text' },
      campaignName: { label: 'Campaign Name', type: 'text' },
      startDate: { label: 'Campaign Start Date', type: 'date' },
      endDate: { label: 'Campaign End Date', type: 'date' },
      totalCompensation: { label: 'Total Compensation ($)', type: 'number' },
      paymentSchedule: { label: 'Payment Schedule', type: 'textarea' },
      deliverables: { label: 'Content Deliverables', type: 'textarea' },
      platforms: { label: 'Platforms (Twitch, YouTube, TikTok, Instagram, etc.)', type: 'textarea' },
      exclusivityPeriod: { label: 'Exclusivity Period (days)', type: 'number' },
      ftcCompliance: { label: 'FTC Compliance Requirements', type: 'textarea' },
      usageRights: { label: 'Content Usage Rights', type: 'textarea' },
      terminationClause: { label: 'Termination Terms', type: 'textarea' },
    },
  },
  'ppa-twitch': {
    title: 'Twitch Partnership Agreement',
    fields: {
      streamerName: { label: 'Streamer Name', type: 'text' },
      twitchUsername: { label: 'Twitch Username', type: 'text' },
      partnershipStartDate: { label: 'Partnership Start Date', type: 'date' },
      revenueSharePercentage: { label: 'Revenue Share Percentage (%)', type: 'number' },
      exclusivityRequired: { label: 'Exclusivity Required', type: 'text' },
      exclusivityPeriod: { label: 'Exclusivity Period', type: 'text' },
      minimumStreamingHours: { label: 'Minimum Streaming Hours per Month', type: 'number' },
      subscriberBenefits: { label: 'Subscriber Benefits Required', type: 'textarea' },
  ...
  'ppa-youtube': {
    ...
    fields: {
      creatorName: { label: 'Creator Name', type: 'text' },
      youtubeChannelName: { label: 'YouTube Channel Name', type: 'text' },
      channelUrl: { label: 'Channel URL', type: 'text' },
      partnershipStartDate: { label: 'Partnership Start Date', type: 'date' },
      monetizationMethod: { label: 'Monetization Method (Ads, Memberships, etc.)', type: 'textarea' },
      revenueSharePercentage: { label: 'Revenue Share Percentage (%)', type: 'number' },
      minimumViews: { label: 'Minimum Views Required', type: 'number' },
      contentOwnership: { label: 'Content Ownership Terms', type: 'textarea' },
      communityGuidelines: { label: 'Community Guidelines Compliance', type: 'textarea' },
      terminationTerms: { label: 'Termination Terms', type: 'textarea' },
    },
  },
  'ppa-tiktok': {
    ...
    fields: {
      creatorName: { label: 'Creator Name', type: 'text' },
      tiktokUsername: { label: 'TikTok Username', type: 'text' },
      fundStartDate: { label: 'Fund Start Date', type: 'date' },
      minimumFollowers: { label: 'Minimum Followers Required', type: 'number' },
      minimumViews: { label: 'Minimum Views Required (per month)', type: 'number' },
      paymentStructure: { label: 'Payment Structure', type: 'textarea' },
      contentRequirements: { label: 'Content Requirements', type: 'textarea' },
      exclusivityTerms: { label: 'Exclusivity Terms', type: 'textarea' },
      platformPolicies: { label: 'Platform Policy Compliance', type: 'textarea' },
      terminationTerms: { label: 'Termination Terms', type: 'textarea' },
    },
  },
  imc: {
    ...
    fields: {
      influencerName: { label: 'Influencer/Streamer Name', type: 'text' },
      managerName: { label: 'Manager/Management Company Name', type: 'text' },
      contractStartDate: { label: 'Contract Start Date', type: 'date' },
      contractEndDate: { label: 'Contract End Date', type: 'date' },
      managementFeePercentage: { label: 'Management Fee Percentage (%)', type: 'number' },
      commissionStructure: { label: 'Commission Structure', type: 'textarea' },
      servicesProvided: { label: 'Services Provided by Manager', type: 'textarea' },
      exclusivityTerms: { label: 'Exclusivity Terms', type: 'textarea' },
      territory: { label: 'Territory', type: 'text' },
      terminationClause: { label: 'Termination Terms', type: 'textarea' },
      renewalTerms: { label: 'Renewal Terms', type: 'textarea' },
    },
  },
};
...
export function ContractForm({ contractId, onSubmit }: ContractFormProps) {
  ...
  >(`trackrights_contract_form_${contractId}`, {});
  const { formData, handleInputChange, resetForm } =
    useContractForm(savedFormData);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    resetForm();
    clearSavedFormData(); // Clear saved form data after successful submission
  };
