    ...
    <>
      ...
      >
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white leading-tight">
          Decode Your{' '}
          <span className="text-purple-300 underline decoration-2 decoration-purple-400">
            Music Contracts
          </span>{' '}
          <span className="separator">|</span> For All Music Professionals{' '}
        ...
        >
          <Button
            size="lg"
            variant="outline"
            className="text-purple-600 border-purple-600 hover:bg-purple-600 hover:text-white px-8 py-3 rounded-full font-bold transition-all duration-300 flex items-center mx-auto"
        ...
        >
          <p>
            Trusted by <span className="font-bold text-yellow-400">5000+</span>{' '}
          ...
          <p className="text-sm text-purple-200 mt-2">
            ...
            <span className="font-bold text-white">50,000+</span> music
            contracts across various roles
          </p>
