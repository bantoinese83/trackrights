...
(globalThis.webpackChunkPSPDFKit = globalThis.webpackChunkPSPDFKit || []).push([
  [1860],
  {
    60919: (e, t, s) => {
      ...
      let a = (function (e) {
        return (
          (e[(e.pdf_a_1a = 0)] = 'pdf_a_1a'),
          (e[(e.pdf_a_1b = 1)] = 'pdf_a_1b'),
          (e[(e.pdf_a_2a = 2)] = 'pdf_a_2a'),
          (e[(e.pdf_a_2u = 3)] = 'pdf_a_2u'),
          (e[(e.pdf_a_2b = 4)] = 'pdf_a_2b'),
          (e[(e.pdf_a_3a = 5)] = 'pdf_a_3a'),
          (e[(e.pdf_a_3u = 6)] = 'pdf_a_3u'),
          (e[(e.pdf_a_3b = 7)] = 'pdf_a_3b'),
          (e[(e.pdf_a_4 = 8)] = 'pdf_a_4'),
          (e[(e.pdf_a_4e = 9)] = 'pdf_a_4e'),
          (e[(e.pdf_a_4f = 10)] = 'pdf_a_4f'),
          e
        );
      })({});
      const o = '/create.pdf',
      ...
      function m(e) {
        let t;
        (0, r.V1)(p, 'GdPicture WebAssembly is not loaded.');
        for (
          ...
          n[a - 1] = arguments[a];
        for (const e of n) t = Object.assign(n[0], e);
        const o = JSON.stringify({ type: e, ...t }),
          i = JSON.parse(p.CommandHandler(o));
        if (!i.success)
          throw new Error(
            i.errorReason + ': ' + i.errorMessage + '\n' + i.error
          );
        return i;
      }
      class h {
        ...
        async loadModule(e, t, s, r, a, o, i) {
          const { Assemblies: l, Module: d } = await (async function (e, t) {
            if ('string' == typeof e) {
              const s = 'pspdfkit-lib/',
                r = `${s}gdpicture-7d551320/jit`,
                n = `${s}gdpicture-7d551320/aot`;
              let a, o;
              t
                ? ((a = `${e}${n}/initDotnet.js`), (o = `${e}${n}`))
                : ((a = `${e}${r}/initDotnet.js`), (o = `${e}${r}`));
              const { initDotnet: i } = await import(a);
              return i(o, (e, t, s, r, n) =>
                'blazor.boot.json' === t
          ...
          if (
            (a &&
              !f.FS.analyzePath(u).exists &&
              (this._mountCustomFonts(a, u),
              m('gdpicture/setFonts', { fontPaths: [u] })),
            o)
          ) {
            const e = await (0, n.sw)(o);
            m('gdpicture/setDynamicFontLoading', {
              baseUrl: o.split('/').slice(0, -1).join('/'),
              allowedFonts: e.availableFonts,
              v: 1,
            });
          }
          i && m('gdpicture/setFontSubstitutions', { fontSubstitutions: i });
        }
        toPdf(e, t) {
          f.FS.writeFile(o, new Uint8Array(e));
          const s = { file: i, format: 'pdf' };
          t && t in a && (s.conformance = t);
          try {
            return (
              m('gdpicture/process', { input: { file: o }, output: s }),
              f.FS.readFile(i).buffer
            );
          } finally {
            try {
              f.FS.unlink(i);
        ...
        toOffice(e, t) {
          ...
          try {
            return (
              m('gdpicture/process', {
                input: { file: o },
                output: { file: s, format: t },
              }),
              f.FS.readFile(s).buffer
            );
          } finally {
            try {
              f.FS.unlink(s);
        ...
        async populateDocumentTemplate(e, t) {
          let s;
          f.FS.writeFile(l, new Uint8Array(e));
          try {
          ...
          try {
            return (
              m('gdpicture/process-office-template', {
                inputFile: l,
                modelAndConfigFile: u,
                outputFile: d,
              }),
              f.FS.readFile(d).buffer
            );
          } finally {
            try {
      ...
      const w = class {
        constructor(e) {
          ...
          ((0, _.A)(this, 'requests', new Map()),
            ...
            this.workerSpawner.setMessageHandler(this.handleMessage),
            (this.moduleLoadPromise = this.sendRequest('loadModule', [
              u ? { baseUrl: t, wasmLoaderPath: u } : t,
              s,
              n,
              a,
              o,
        ...
        toPdf(e, t) {
          let s;
          return (
            t && (s = t.replace('pdf', 'pdf_').replaceAll('-', '_')),
            this.sendRequest('toPdf', [e, s])
          );
        }
        async populateDocumentTemplate(e, t) {
      ...
      const g = async function () {
        ...
        if (t) {
          const { default: t } = await s.e(11).then(s.bind(s, 37979));
          e = new t();
